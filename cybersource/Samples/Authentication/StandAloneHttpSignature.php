...
$merchant_id = "cstown_pay";
$merchant_key_id = "0e411bf4-58ea-4766-a5a3-faa25988867c";
$merchant_secret_key = "e1V6nnaIibq12D4sYTOd/leWgK/WoP7hUhq6vvCQxkY=";
...
{    
    ...
    $resource = '/reporting/v3/reports?startTime=2020-04-07T00:00:00.0Z&endTime=2020-04-09T23:59:59.0Z&timeQueryType=executedTime&reportMimeType=application/xml';
    $method = "get";
    $statusCode = -1;
    $url = "https://" . $request_host . $resource;
