<?php /* Smarty version 2.6.22, created on 2015-06-19 14:29:20
         compiled from register_storage/index.html */ ?>
...
/register_storage/index" method="get">
	<div class="searchBar">
...
/register_storage/procurement_warehousing/" target="navTab" rel="procurement_warehousing"  ><span>采购入库</span></a></li>
			<li class="line">line</li>-->
		</ul>
	</div>
	<table class="table" width="1200" layoutH="138">
		<thead>
			...
			<tr>
            	<th width="10"><input type="checkbox" group="group_ids_duizhang[]" class="checkboxCtrl"></th>
                <th width="10">编号</th>
                <th width="30">采购时间</th>
                <th width="30">入库状态</th>
                <th width="30">对账状态</th>
...
/register_storage/edit-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
...
/register_storage/change_to_duizhang-'+p,
					type:'get', 
					dataType:'json',
					data:p,
