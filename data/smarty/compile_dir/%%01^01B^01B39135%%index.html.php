<?php /* Smarty version 2.6.22, created on 2013-09-05 17:10:34
         compiled from declare_product_name/index.html */ ?>
...
/declare_product_name/index" method="get">
	<div class="searchBar">
		<ul class="searchContent">
			<li style="width:30%">
				<label style="width:100px">报关产品名称：</label>
...
/declare_product_name/add/" target="dialog" rel="page1"><span>添加</span></a></li>
	...
	<table class="table" width="1200" layoutH="138">
		<thead>
			<tr>
                ...
                <th width="30">时间</th>
                <th width="30">报关产品名称</th>
                <th width="30">操作</th>
			</tr>
		</thead>
		<tbody>
        <?php if ($this->_tpl_vars['declare_product_name']): ?>
