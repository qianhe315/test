<?php /* Smarty version 2.6.22, created on 2013-09-05 17:05:00
         compiled from time/index.html */ ?>
...
" />
    ...
    <input type="hidden" name="time_name" value="<?php echo $this->_tpl_vars['time_name']; ?>
" />
</form>

<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/time/index" method="get">
	<div class="searchBar">
		<ul class="searchContent">
			<li style="width:30%">
				<label>时间名称：</label>
				<input type="text" name="time_name" value="<?php echo $this->_tpl_vars['time_name']; ?>
"/>
			</li>
...
/time/add/" target="dialog" rel="page1"><span>添加时间</span></a></li>
