<?php /* Smarty version 2.6.22, created on 2016-08-29 09:52:08
         compiled from cn_sale_detail/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_sale_detail/index">
...
/cn_sale_detail/index" method="get">
	<div class="searchBar">
...
/cn_sale_detail/search/" target="dialog" mask="true" title="查询框"><span>高级检索</span></a></li> 
...
/cn_sale_detail/sd_xls_export" method="post" id="sale_detail_export">
...
/cn_sale_detail/deliver_list_all"><span>查看全部发货信息</span></a></li>
             <li class="line">line</li>
...
/sale_detail/bulk_order_code_delivery"><span>批量订单扫码发货</span></a></li>
			 ...
			 <?php endif; ?>
          	 <!--<li class="line">line</li>
             <?php if ($this->_tpl_vars['user_hidden']['user_id'] == '1' || $this->_tpl_vars['user_hidden']['user_id'] == '2' || $this->_tpl_vars['user_hidden']['user_id'] == '38' || $this->_tpl_vars['user_hidden']['user_id'] == '13'): ?>
...
/sale_detail/yinyue-ce-1.html" target="_block" ><span>上单声音提醒</span></a></li>
             <?php endif; ?>
             <li><a class="add" href="#" id="s_create_invoice" ><span>生成发票</span></a></li>
             <li><a class="add" href="#" id="s_create_no_image"><span>生成发票无图片(适用超过20条订单的发票)</span></a></li>-->
	...
	<table class="table" width="1600" layoutH="138">
		<thead>
			<tr>
                ...
                <?php if ($this->_tpl_vars['session_id'] != 65 && $this->_tpl_vars['session_id'] != 66): ?>
                <th width="20%" colspan="4">已付金额&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||手续费&nbsp;&nbsp;&nbsp;&nbsp;||净额&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||余额&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||付款时间&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||付款方式</td>
...
?>
                 <tr>
                 <td  width="44" style="text-align:right;"><?php echo $this->_tpl_vars['d']['paid_money']; ?>
</td>
				 <td  width="44" style="text-align:right;"><?php echo $this->_tpl_vars['d']['poundage']; ?>
</td>
                 <td  width="44" style="text-align:right;"><?php echo $this->_tpl_vars['d']['net_worth']; ?>
</td>                   
                 <td  width="64" style="text-align:right;"><?php echo $this->_tpl_vars['d']['balance']; ?>
</td>
...
.html" class="btnAdd">编辑</a>
                    ...
                    <?php if ($this->_tpl_vars['user_hidden']['user_name'] == $this->_tpl_vars['dis']['saleman_name'] || $this->_tpl_vars['user_hidden']['group_id'] == '5'): ?>
                        <?php if ($this->_tpl_vars['dis']['paid_status'] == '2' || $this->_tpl_vars['dis']['paid_status'] == '3'): ?>                
                            <a title="退款申请" class="btnDel" target="dialog" rel="refund_application" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_sale_detail/refund_application-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd">编辑</a>
                        <?php endif; ?>
                    <?php endif; ?>
...
/cn_sale_detail/return_back-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd"></a>  
     				<?php endif; ?>            
                </td>                
              </tr>
...
/cn_sale_detail/invoice_status-'+p,//通过Ajax取数据的目标页面
								data:p,
						...
						for(var i=0;i<saleman_name01.length;i++){
							...
							if(saleman_name01[i]){
								if(saleman_name01[i]!= $("#sd_ssaleman_id").val() && $("#sd_ssaleman_id").val() != 'admin'){
									...
									$.ajax({
										url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_sale_detail/fp_duo',//通过Ajax取数据的目标页面
										data:{'id':check_arr},			
										type:'get',//方法，还可以是"post"
						...
						for(var i=0;i<saleman_name01.length;i++){
							...
							if(saleman_name01[i]){
								if(saleman_name01[i]!= $("#sd_ssaleman_id").val() && $("#sd_ssaleman_id").val() != 'admin'){
									...
									$.ajax({
										url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_sale_detail/fp',//通过Ajax取数据的目标页面
										data:{'id':check_arr},			
										type:'get',//方法，还可以是"post"
										dataType:'json',//数据类型，还有其它的，详见jQuery手册
										success:function(locals)//成功后执行的语句，这里是一个函数，"locals"是返回的数据
