<?php /* Smarty version 2.6.22, created on 2015-11-26 17:14:04
         compiled from supplier_management_cn/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/supplier_management_cn/index">
...
/supplier_management_cn/index" method="get">
	<div class="searchBar">
...
/supplier_management_cn/add" target="navTab" rel="supplier_management_cn_add"><span>添加</span></a></li>
            <li class="line">line</li>
           <!-- <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
	...
	<table class="table" width="1200" layoutH="138">
		<thead>       		
            ...
            <th width="22"><input type="checkbox" group="group_ids" class="checkboxCtrl"></th>
                ...
                <th width="30">时间</th>
                <th width="30">代码</th>
                <th width="30">供应商（公司全称）</th>
                <th width="30">供应商（简称）</th>
                <th width="30">联系人</th>
                <th width="30">电话</th>
                <th width="30">传真</th>
                <th width="30">邮箱</th>
...
/supplier_management_cn/color-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
...
/supplier_management_cn/del-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnDel">删除</a>   <a title="编辑" target="navTab" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/supplier_management_cn/edit-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
