<?php /* Smarty version 2.6.22, created on 2016-03-07 17:18:07
         compiled from cn_unfinishdesign/add.html */ ?>
...
<div class="pageContent">
  <div class="stkInfEnter" layoutH="100" style="width:97%; margin-left:20px;">
    ...
    <div class="sIEK" style="width:30%;" id="table_size">
        ...
        <div class="sIE_l" style="width:260px;">
          ...
          <div style="float:left; margin-bottom:5px;">
            <div class="sIE_l_01_title">设计类别:</div>
              <input type="text" readonly class="sIE_No" style="width:100px;"  name="design_category" id="design_category" value="T恤设计"/>
          </div>
          <div style="float:left; margin-bottom:5px;">
          
            <div class="sIE_l_01_title">设计编号:</div>
            <input type="text" class="sIE_No"  name="design_code" style="width:120px;" id="design_code" value="<?php echo $this->_tpl_vars['design_code']; ?>
" readonly />
          </div>
...
?>
              <option <?php if ($this->_tpl_vars['design']['make_pic_time'] == $this->_tpl_vars['time']['id']): ?>selected="selected"<?php endif; ?>  value="<?php echo $this->_tpl_vars['place']['id']; ?>
...
" />
         ...
         <textarea class="add01_textarea" readonly="readonly" onfocus="if(this.value=='备注')this.value='';" style="width:220px; height:140px; margin-left:10px;"><?php if ($this->_tpl_vars['design']['note']): ?><?php echo $this->_tpl_vars['design']['note']; ?>
