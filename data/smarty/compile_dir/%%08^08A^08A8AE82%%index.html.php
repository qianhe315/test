<?php /* Smarty version 2.6.22, created on 2015-04-21 11:21:18
         compiled from monthly_fee/index.html */ ?>
...
" />
    <input type="hidden" name="subsidy_program" value="<?php echo $this->_tpl_vars['subsidy_program']; ?>
" />
</form>

<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/monthly_fee/index" method="get">
	<div class="searchBar">
...
" <?php if ($this->_tpl_vars['name'] == $this->_tpl_vars['ta']['name']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['ta']['name']; ?>
            ...
            <li style="width:30%;">
				...
				<select class="combox" name="program"  >
                    ...
                    <option value="考勤扣费" <?php if ($this->_tpl_vars['program'] == '考勤扣费'): ?> selected="selected"<?php endif; ?>>考勤扣费</option>
                    <option value="请假扣费" <?php if ($this->_tpl_vars['program'] == '请假扣费'): ?> selected="selected"<?php endif; ?>>请假扣费</option>
                    <option value="个税" 	<?php if ($this->_tpl_vars['program'] == '个税'): ?> 	selected="selected"<?php endif; ?>>个税</option>
                </select>
			</li>
...
/monthly_fee/add/" target="dialog" rel="page1"><span>添加</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['monthly_list']): ?>
			 <?php $_from = $this->_tpl_vars['monthly_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
/monthly_fee/del-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/monthly_fee/edit-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
