<?php /* Smarty version 2.6.22, created on 2016-01-15 09:41:37
         compiled from stock_surplus/material_procurement.html */ ?>
...
" />
          <input type="hidden" name="material_chinese_name[]" value="<?php echo $this->_tpl_vars['q']['material_chinese_name']; ?>
" />
...
" />
          <input type="hidden" name="unit[]" value="<?php echo $this->_tpl_vars['q']['use_unit']; ?>
" />
                <tr target="sid_user" rel="<?php echo $this->_tpl_vars['k']+1; ?>
" >
                <td><?php echo $this->_tpl_vars['q']['material_name']; ?>
</td>
                 <td><?php echo $this->_tpl_vars['q']['material_chinese_name']; ?>
</td>
