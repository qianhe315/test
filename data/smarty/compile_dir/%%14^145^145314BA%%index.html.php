<?php /* Smarty version 2.6.22, created on 2023-06-12 16:18:47
         compiled from payment_registration/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/payment_registration/index">
...
/payment_registration/index" method="get" id="f_id">
...
/payment_registration/search/" target="dialog" mask="true" title="查询框"><span>高级检索</span></a></li> 
...
/payment_registration/pr_xls_export" method="post" id="payment_registration_export">
...
/payment_registration/customer_payment-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd" fresh="true" >客户付款</a>
               <?php endif; ?>
               <?php if ($this->_tpl_vars['dis']['paid_status'] == '2' || $this->_tpl_vars['dis']['paid_status'] == '3'): ?>  
                  <?php if ($this->_tpl_vars['user_id'] == '51' || $this->_tpl_vars['user_id'] == '1'): ?>
                   <a title="删除吗？" target="ajaxTodo" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/payment_registration/del_payment-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
