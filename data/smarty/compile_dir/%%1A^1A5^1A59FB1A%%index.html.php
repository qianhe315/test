<?php /* Smarty version 2.6.22, created on 2015-11-27 10:59:01
         compiled from six_coefficient/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/six_coefficient/index">
...
/six_coefficient/index" method="get">
	<div class="searchBar">
...
/six_coefficient/add" target="dialog" rel="supplier_attributes"  ><span>添加</span></a></li>
            <li class="line">line</li>
	...
	<thead>
			...
			<tr>
                 ...
                 <th width="30">单价下限</th>
                 <th width="30">单价上限</th>
                 <th width="30">报价系数下限</th>
                 <th width="30">报价系数上限</th>
                 <th width="30">操作</th>
			</tr>
		</thead>
		<tbody>
        <?php if ($this->_tpl_vars['six_coefficient']): ?>
...
" type="checkbox"></td>
                ...
                <td><?php echo $this->_tpl_vars['dis']['under']; ?>
</td>
                <td><?php echo $this->_tpl_vars['dis']['up']; ?>
</td>
                <td><?php echo $this->_tpl_vars['dis']['coefficient_under']; ?>
</td>
                <td><?php echo $this->_tpl_vars['dis']['coefficient_up']; ?>
</td>
                <td><a title="删除吗？" target="ajaxTodo" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/six_coefficient/del-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" rel="supplier_attributes_edit" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/six_coefficient/edit-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
