<?php /* Smarty version 2.6.22, created on 2014-08-01 11:08:29
         compiled from template_quotation/add_production_order.html */ ?>
...
" class="sIE_No"  readonly="readonly" />
                ...
                <div class="sIE_l_01" style="width:200px;">
                  <div class="sIE_l_01_title">报价名称:</div>
                    <input type="text" name="design_pic_name" style="width:100px;" value="<?php echo $this->_tpl_vars['design_pic_name']; ?>
" class="sIE_No" id="design_pic_name" readonly="readonly"/>
                </div> 
...
" class="sIE_No" id="customer_company"  readonly="readonly" />
              ...
              <input class="sIE_No " id="customer_order" style="width:100px; margin-top:-2px;" type="text" name="customer_order" value=" ">
                </div>
                  <div class="sIE_l_01" style="width:200px;">
                ...
                <div class="sIE_l_01" style="width:200px;margin-top:-50px; margin-right:-220px;">
                  <div class="sIE_l_01_title" style=" margin-left:-400px; margin-top:49px;">纸板面积:</div>
                  <div style="margin-left:-320px; margin-top:60px;">
                    <input class="sIE_No " id="template_area" style="width:50px; margin-top:-10px;" type="text" name="template_area" value="<?php echo $this->_tpl_vars['template_area']; ?>
" readonly="readonly"> 平方英寸
                    </div>
               
                </div>
       <textarea class="add01_textarea textInput" style="width:180px;height:65px; margin-bottom:10px; margin-left:210px;" onfocus="if(this.value=='销售备注')this.value='';" name="remark">销售备注</textarea>
                <div id="cdr_error" style="float:left; width:500px; margin-top:10px; color:#F00; display:none; font-size:12px;"></div>
                <div class="sIE_l_01" style="width:200px; margin-top:-90px;">
                  <div class="sIE_l_01_title">打版数量:</div>
                 <input class="sIE_No" id="template_number" style="width:100px; " type="text" name="template_number" value="<?php echo $this->_tpl_vars['template_number']; ?>
" readonly="readonly"/>
             
                </div>
                <div class="sIE_l_01" style="width:200px; margin-top:-57px;">
                  <div class="sIE_l_01_title">报价:</div>
                 <input class="sIE_No" id="final_quote" style="width:100px; " type="text" name="final_quote" value="<?php echo $this->_tpl_vars['final_quote']; ?>
" readonly="readonly"/>
