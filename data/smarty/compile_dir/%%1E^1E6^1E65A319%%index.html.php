<?php /* Smarty version 2.6.22, created on 2014-01-09 09:57:01
         compiled from goods_after_payment_manager/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/goods_after_payment_manager/index">
...
/goods_after_payment_manager/index" method="get">
	<div class="searchBar">
...
/goods_free/reason_rejection/" target="dialog" ><span>驳回</span></a></li>
	...
	<table class="table" width="1200" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['goods_after_payment_manager']): ?>
			 <?php $_from = $this->_tpl_vars['goods_after_payment_manager']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
/goods_after_payment_manager/approved-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd">审核通过</a>
                <a title="驳回" target="dialog" rel="goods_free" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/goods_after_payment_manager/reason_rejection-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
