<?php /* Smarty version 2.6.22, created on 2024-10-24 14:13:21
         compiled from revieweddesign/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/revieweddesign/index">
...
/revieweddesign/index" method="get">
	<div class="searchBar">
...
/finishdesign/shtg/" target="selectedTodo" rel="group_ids[]" postType="string" title="确定返回已完成?" ><span>返回已完成</span></a>
            ...
            <?php if ($this->_tpl_vars['user_hidden']['group_id'] == '50' || $this->_tpl_vars['user_hidden']['group_id'] == '53' || $this->_tpl_vars['user_hidden']['group_id'] == '5' || $this->_tpl_vars['user_hidden']['group_id'] == '68'): ?>
            <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/unassigneddesign/add_lhpl-check-1" target="navTab" rel="unfinishdesign_change" ><span>添加灵活品类设计</span></a></li>
            <li class="line">line</li>
            <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/unfinishdesign/add-check-1" target="navTab" rel="unfinishdesign_change" ><span>添加烫图设计</span></a></li>
            <li class="line">line</li>
            <?php endif; ?>
		</ul>
	</div>
...
" width="100px" height="100px" ></td>
                <?php endif; ?>
 				<!--<td><?php if ($this->_tpl_vars['dis']['status'] == '1'): ?>未完成<?php elseif ($this->_tpl_vars['dis']['status'] == '2'): ?>未检验<?php elseif ($this->_tpl_vars['dis']['status'] == '3'): ?>已完成<?php elseif ($this->_tpl_vars['dis']['status'] == '4'): ?>通过审核<?php elseif ($this->_tpl_vars['dis']['status'] == '5'): ?>返回申请中<?php elseif ($this->_tpl_vars['dis']['status'] == '6'): ?>人工介入<?php endif; ?></td>-->
...
<?php endif; ?></td>
                ...
                <td>
                 ...
                 <a title="已审核-版图管理" target="navTab" rel="finishdesign_verify" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/finishdesign/design_list-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
-reviewed-1.html" class="btnInfo" fresh="true" >已审核-版图管理</a>
