<?php /* Smarty version 2.6.22, created on 2016-03-25 14:45:34
         compiled from cn_stock_manage/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_stock_manage/index">
...
/cn_stock_manage/index" method="get">
	<div class="searchBar">
...
/cn_stock_manage/add/" target="navTab" rel="stock_manage_add" ><span>添加STOCK</span></a></li>
			<li class="line">line</li>
            <?php if ($this->_tpl_vars['user_hidden']['user_id'] == '1' || $this->_tpl_vars['user_hidden']['user_id'] == '2'): ?>
            <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_stock_manage/update_use/" target="selectedTodo" id="del" rel="group_ids[]" postType="string" title="确定改为使用报价系数？"><span>使用报价系数</span></a></li>
            
        
            <li class="line">line</li>
            <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_stock_manage/update_no_use/" target="selectedTodo" id="del" rel="group_ids[]" postType="string" title="确定改为不使用报价系数？"><span>不使用报价系数</span></a></li>
            <?php endif; ?>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="138">
		<thead>
			<tr>
                ...
                <th width="14%">缩略图</th>
                <th width="14%">时间</th>
                <th width="14%">STOCK编号</th>
                <th width="10%">STOCK类型</th>
                <th width="14%">烫图尺寸</th>
                <th width="10%">报价系数状态</th>
                <th width="10%">报价系数值</th>
                <th width="10%">操作</th>
			</tr>
		</thead>
		<tbody>
...
/cn_stock_manage/del-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
...
/cn_stock_manage/edit-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
