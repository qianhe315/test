<?php /* Smarty version 2.6.22, created on 2014-01-04 09:37:14
         compiled from create_quotation_invoice/create_quotation_image.html */ ?>
                      ...
                      <div class="quoteK_div">
                        <div class="quoteK_r">
                          ...
                          <div class="quoteK_r_nr">
                            ...
                            <div class="quoteK_r_nr_r"><input type="text" name="price" id="due" readonly value="<?php echo $this->_tpl_vars['price']; ?>
