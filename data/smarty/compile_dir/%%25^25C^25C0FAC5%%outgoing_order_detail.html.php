<?php /* Smarty version 2.6.22, created on 2024-08-27 09:06:36
         compiled from product_order/outgoing_order_detail.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'product_order/outgoing_order_detail.html', 721, false),)), $this); ?>
...
" class="sIE_No" />
                ...
                <div class="sIE_l_01" style="width:180px;">
                    ...
                    <select class="picture_select01" id="size_type" name="size_type" style="height:26px; width:106px;">
                      <option <?php if ($this->_tpl_vars['quotation_sheet']['size_type'] == ''): ?>selected="selected"<?php endif; ?> value="">请选择</option>
                      <option <?php if ($this->_tpl_vars['quotation_sheet']['size_type'] == '1'): ?>selected="selected"<?php endif; ?> value="1">工厂尺码</option>
                      <option <?php if ($this->_tpl_vars['quotation_sheet']['size_type'] == '2'): ?>selected="selected"<?php endif; ?> value="2">客户尺码</option>
                  	</select>
                </div>
                <div class="sIE_l_01" style="width:180px;">
...
" class="sIE_No" />
                ...
                <div style="float:left; width:160px; margin-left:10px;">
                    <textarea name="remark" <?php if ($this->_tpl_vars['outbound_return_order'] != 1): ?>readonly<?php endif; ?> style="width:160px; margin-bottom:10px;" class="add01_textarea textInput"><?php echo $this->_tpl_vars['quotation_sheet']['remark']; ?>
</textarea>
                </div>
...
">
                                    ...
                                    <select class="picture_select01 size" id='row_size_<?php echo $this->_tpl_vars['attribute_row']; ?>
' name='row[<?php echo $this->_tpl_vars['attribute_row']; ?>
...
" class="total_number">
 ...
 -->
                            <input type='hidden' id="amount_<?php echo $this->_tpl_vars['qsc']['en_name']; ?>
" value='<?php echo $this->_tpl_vars['qsc']['total']; ?>
'>
                            <?php endforeach; endif; unset($_from); ?>
                            <td> </td>
                        </tr>
...
'><?php echo $this->_tpl_vars['sc']['en_name']; ?>
                            ...
                            $(".select_category").each(function (e){
                                ...
                                html+='<td class="row'+category_arr[2]+'" id="'+$(this).attr("en")+'_row'+attribute_row+'"><input type="text" size="3" class="col_'+e+'" size_row="'+attribute_row+'" row="row['+attribute_row+']" name="'+name+'" onchange=count_total('+e+',"'+$(this).attr("en")+'")></td>';
                            });
                        ...
                        function getEdit_detaile(size,attribute_row){
                            ...
                            $(".select_category").each(function (e){
                                ...
                                html+='<table cellspacing="0" id="'+$(this).attr("en")+'"  style="margin-top:10px; width:96%; margin-left:2%;">';
...
' style='width:100px;'>
                                ...
                                <?php endif; ?>
                                <td class='oqs_number'>
                                    <input type='text' class="col_1 <?php echo $this->_tpl_vars['sq']['en_name']; ?>
...
'>
                ...
                <div class="sIE_l_01" style="width:230px; margin-top:10px;display: none">
                    ...
                    <input type="text"  class="sIE_No" style="width:100px;" id="outgoing_inquiry_sheet_number_add" name="number" value="<?php echo $this->_tpl_vars['quotation_sheet']['number']; ?>
" />
                </div>
...
" />
                <div class="sIE_l_01" style="color:red;width:100%; margin-top:10px; font-size:14px;">
                    <?php if ($this->_tpl_vars['quotation_sheet']['new_time'] != ''): ?>
                        订单已付款，除总计数量其它均可修改。
                    <?php elseif ($this->_tpl_vars['quotation_sheet']['invoice_number'] != ''): ?>
                        请先删除该订单的发票在编辑尺码信息。
                    <?php else: ?>
                        减少数量：初始数量12件及以上的 可调减最多30% ；12件以下的 不允许减；尺码可随意改动。<br><br>增加数量：修改不受限制。
                    <?php endif; ?>
                </div>
...
" /><span style="line-height: 26px">元</span>
                    ...
                    <div class="sIE_l_01" style="width:33%;">
                        ...
                        <input type="text" name="quote_coefficient" readonly id="coefficient_id_production" onkeyup="sales_quotation_calculation()" class="sIE_No" value="<?php echo $this->_tpl_vars['quote_coefficient']; ?>
" style="width:100px;" />
                        <?php else: ?>
                        <input type="text" name="quote_coefficient" readonly id="coefficient_id_production" onkeyup="sales_quotation_calculation()" class="sIE_No" value="<?php echo $this->_tpl_vars['default_quote_coefficient']; ?>
" style="width:100px;" />
                        <?php endif; ?>
...
" id="sales_bidding_price" class="sIE_No" style="width:100px;" />
                    ...
                    <div class="sIE_l_01" style="width:50%;">
                        ...
                        <input type="text" name="design_cost" readonly id="design_cost" onkeyup="sales_quotation_calculation()" value="<?php echo $this->_tpl_vars['outgoing_quotation_sheet']['design_fee']; ?>
" class="sIE_No" style="width:100px;" />
                    </div>
                    <div class="sIE_l_01" style="width:50%;">
                        <div class="sIE_l_01_title" style="width:60px;">版费报价:</div>
                        <input type="text" name="edition_cost" readonly id="edition_cost" onkeyup="sales_quotation_calculation()" value="<?php echo $this->_tpl_vars['outgoing_quotation_sheet']['edition_price']; ?>
" class="sIE_No" style="width:100px;" />
                    </div>
...
'><?php echo $this->_tpl_vars['sc']['cn_name']; ?>
                    ...
                    function change_number(key,size_category_id,del_row){
                        if(size_category_id==68){
                            ...
                            $("#outgoing_inquiry_sheet_number_add").val(total_nubmer);
                            if(del_row==1){
...
" />
            <input type="hidden" id="new_time" value="<?php echo $this->_tpl_vars['quotation_sheet']['new_time']; ?>
" />
            <input type="hidden" id="invoice_number" value="<?php echo $this->_tpl_vars['quotation_sheet']['invoice_number']; ?>
" />
...
" /></div>
    ...
    <div class="formBar">
        <div class="sIE_l_02">
            ...
            <div class="button" style="float:right; margin-right:5px;">
                <div class="buttonContent">
                    <button id="add_return_order">确定</button>
                </div>
            </div>
        </div>
    </div>
...
/product_order/modify_documentary',//通过Ajax取数据的目标页面
    ...
    $("#add_return_order1").click(function (){
        var size=0;
        $(".size").each(function (){
            if($(this).val()==''){
                ++size;
    ...
    $("#add_return_order").click(function() {
        ...
        if(number_part==1){
            ...
            if($(".non_clothing").length>0){
                var col_total=0;
                $(".non_clothing").each(function(){
                    if($(this).val()!="")
                        col_total+=parseInt($(this).val());
                });
                if(col_total!=$("#amount_non_clothing").val()){
                    alert("非服装尺码总数量与总计不符，请修改。"+col_total);
                    flag=2;
                }
            }else{
                <?php $_from = $this->_tpl_vars['quotation_size_chart_category']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['category1'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['category1']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['qsc']):
        $this->_foreach['category1']['iteration']++;
?>
                var col_total=0;
                $(".col_<?php echo $this->_foreach['category1']['iteration']; ?>
").each(function(){
                    if($(this).val()!="")
                        col_total+=parseInt($(this).val());
                });
                if(col_total!=$("#amount_<?php echo $this->_tpl_vars['qsc']['en_name']; ?>
").val()){
                    alert("<?php echo $this->_tpl_vars['qsc']['cn_name']; ?>
尺码总数量与总计不符，请修改。"+col_total);
                    flag=2;
                }
                <?php endforeach; endif; unset($_from); ?>
            }
            ...
            if(parseInt(number_id)!=parseInt($("#total_number_id").val())){
                alert("已生成发票，请先删除发票，再修改总数量!");
