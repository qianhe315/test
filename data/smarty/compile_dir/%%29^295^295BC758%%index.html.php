<?php /* Smarty version 2.6.22, created on 2024-08-27 10:52:03
         compiled from material/index.html */ ?>
...
">
              	...
              	<td><?php echo $this->_tpl_vars['ug']['s_time']; ?>
</td>
                <td><?php echo $this->_tpl_vars['ug']['material_name']; ?>
</td>
 				<td><?php echo $this->_tpl_vars['ug']['material_color']; ?>
</td>
                <td><?php if ($this->_tpl_vars['ug']['size'] != ''): ?>
                <?php echo $this->_tpl_vars['ug']['size']; ?>

                <?php elseif ($this->_tpl_vars['ug']['size_mm'] != ''): ?>
                <?php echo $this->_tpl_vars['ug']['size_mm']; ?>
mm
                <?php elseif ($this->_tpl_vars['ug']['size_m_w'] != '' && $this->_tpl_vars['ug']['size_m_h'] != ''): ?>
                <?php echo $this->_tpl_vars['ug']['size_m_w']; ?>
mm *<?php echo $this->_tpl_vars['ug']['size_m_h']; ?>
mm<?php endif; ?></td>  
                <td></td>
                <td>
...
元
                ...
                <?php if ($this->_tpl_vars['ug']['factory_price'] != ''): ?>
                <td><?php echo $this->_tpl_vars['ug']['factory_price']; ?>
元</td>
                <?php else: ?>
...
/material/edit-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
