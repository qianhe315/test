<?php /* Smarty version 2.6.22, created on 2016-01-09 11:33:47
         compiled from cn_jst_exit_storehouse/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_jst_exit_storehouse/index">
...
/cn_jst_exit_storehouse/index" method="get">
	<div class="searchBar">
...
/cn_jst_exit_storehouse/xls_export" method="post" id="new_export_new">
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
        	<li class="line">line</li>
			<li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_jst_exit_storehouse/add" target="dialog" rel="cn_jst_exit_storehouse"><span>添加</span></a></li>
            <li class="line">line</li>
           ...
           <li><a class="icon" href="#" id="new_ex" ><span>导出EXCEL</span></a></li>
			<li class="line">line</li>
            <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_jst_exit_storehouse/materials_exit" target="navTab" rel="tongbu_add"  ><span>材料扫码出库</span></a></li>
             <li class="line">line</li>
			 <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_jst_exit_storehouse/del_piliang/" target="selectedTodo" id="del" rel="group_ids[]" postType="string" title="确定要批量删除？"><span>批量删除</span></a></li>
		</ul>
	</div>
	<table class="table" width="98%" layoutH="138">
        ...
        <?php if ($this->_tpl_vars['cn_jst_out_material_register']): ?>
			 <?php $_from = $this->_tpl_vars['cn_jst_out_material_register']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
/cn_jst_exit_storehouse/del-id-<?php echo $this->_tpl_vars['omr']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" rel="exit_storehouse_edit" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_jst_exit_storehouse/edit-id-<?php echo $this->_tpl_vars['omr']['id']; ?>
...
/cn_jst_exit_storehouse/change_price',
			type:'post',
			dataType:"text",
...
function where_is_ok(id){
	...
	$.ajax({
		url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_jst_exit_storehouse/change_where',
		type:'post',
		dataType:"text",
