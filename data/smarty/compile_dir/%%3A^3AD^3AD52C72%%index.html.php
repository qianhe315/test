<?php /* Smarty version 2.6.22, created on 2013-09-06 09:02:56
         compiled from supplier_settlement_time/index.html */ ?>
...
/supplier_settlement_time/add" target="dialog" rel="supplier_settlement_time"  ><span>添加</span></a></li>
            <li class="line">line</li>
	...
	<table class="table" width="1200" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['supplier_settlement_time']): ?>
...
" type="checkbox"></td>
                ...
                <td><?php echo $this->_tpl_vars['dis']['cycle']; ?>
</td>
                <td><a title="删除吗？" target="ajaxTodo" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/supplier_settlement_time/del-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" rel="supplier_settlement_time_edit" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/supplier_settlement_time/edit-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
