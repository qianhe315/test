<?php /* Smarty version 2.6.22, created on 2025-01-03 09:30:46
         compiled from product_order/hotfix_quotation_order.html */ ?>
              ...
              <div class="sIE_l">
               <div class="sIE_l_01">
                  <div class="sIE_l_01_title">跟单人:</div>
                    <select  name="sale_user" <?php if ($this->_tpl_vars['saleman_name'] != $this->_tpl_vars['sale_user'] && $this->_tpl_vars['salesman'] != 'admin'): ?>disabled="disabled"<?php endif; ?> id="documentary">
...
" readonly class="sIE_No" />
                ...
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">发货期:</div>
					<input type="text" name="customer_name" value="<?php echo $this->_tpl_vars['deliver_goods']; ?>
" readonly class="sIE_No" />
                </div>
                <div class="sIE_l_01">
...
" readonly class="sIE_No" />
                ...
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">返单号:</div>
                    ...
                    <input type="text" name="single_number" value="<?php echo $this->_tpl_vars['return_number']; ?>
" readonly class="sIE_No" />
                </div>
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">数量:</div>
                    
                    <input type="text" name="pcs" value="<?php echo $this->_tpl_vars['number']; ?>
" readonly class="sIE_No" />
                </div>
                <div class="sIE_l_01">
...
" readonly class="sIE_No" />
                ...
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">版费:</div>
                    ...
                    <input type="text" name="costs" value="<?php echo $this->_tpl_vars['edition_price']; ?>
" readonly class="sIE_No" />
                </div>

                <div class="sIE_l_01">
                  <div class="sIE_l_01_title" style="line-height:24px;">备损数量:</div>
                    
                    <input type="text" name="preparation_number" readonly value="<?php echo $this->_tpl_vars['preparation_number']; ?>
" class="sIE_No" />
                </div>
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title" style="line-height:24px;">烫压测试:</div>
                  <?php if ($this->_tpl_vars['hot_test'] == '1'): ?>
                    <input type="text" name="hot_test" readonly value="是" class="sIE_No" />
                  <?php else: ?>
                  	<input type="text" name="hot_test" readonly value="否" class="sIE_No" />
                  <?php endif; ?>
                </div>
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title" style="line-height:24px;">工厂烫压:</div>
                  <?php if ($this->_tpl_vars['factory_hot'] == '1'): ?>
                    <input type="text" name="factory_hot" readonly value="是" class="sIE_No" />
                  <?php else: ?>
                  	<input type="text" name="factory_hot" readonly value="否" class="sIE_No" />
                  <?php endif; ?>
                </div>  
                <div class="sIE_l_01" style="margin-left:225px;">
                  <div class="sIE_l_01_title" style="line-height:24px;">多图虚线切割:</div>
                  <?php if ($this->_tpl_vars['dotted_line'] == '1'): ?>
                    <input type="text" name="hot_test" readonly value="是" class="sIE_No" />
                  <?php else: ?>
                  	<input type="text" name="hot_test" readonly value="否" class="sIE_No" />
                  <?php endif; ?>
                ...
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">产品分类:</div>
                    ...
                    <input type="text" name="customers_order" value="<?php echo $this->_tpl_vars['product_type']; ?>
" readonly class="sIE_No" />
                </div>
...
" />  
             <input type="hidden" name="order_category" value="<?php echo $this->_tpl_vars['order_category']; ?>
" /> 
              
    	  	</div>
            
            
            <!--<textarea name="remark" class="add01_textarea" style="width:800px; margin-bottom:10px;"><?php echo $this->_tpl_vars['remark']; ?>
</textarea>-->
