<?php /* Smarty version 2.6.22, created on 2014-08-28 17:18:12
         compiled from exceptions_customers/add.html */ ?>
...
$(document).ready(function()  
{
	...
	var url = $("#url").val();
	var bb = url + \'/exceptions_customers/check_customer_name\';
		if(customer_name!=""){
			$.ajax({
				  url:bb,
