<?php /* Smarty version 2.6.22, created on 2016-03-25 11:17:16
         compiled from cn_payment_after_delivery/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_payment_after_delivery/index">
...
/cn_payment_after_delivery/index" method="get">
	<div class="searchBar">
...
/cn_payment_after_delivery/pad_xls_export" method="post" id="payment_after_delivery_export">
...
/cn_payment_after_delivery/shtg/" target="selectedTodo" rel="group_ids[]" postType="string" title="确定批量修改?" ><span>批量审核通过</span></a>
         </li>
		 
         <li><a class="icon" href="#" id="pad_ex" ><span>导出EXCEL</span></a></li>
         <li class="line">line</li>
         <?php endif; ?>
         </ul>
	</div>
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['payment_after_delivery']): ?>
			 <?php $_from = $this->_tpl_vars['payment_after_delivery']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
" type="checkbox"></td>
                ...
                <td style="text-align:right;"><?php echo $this->_tpl_vars['dis']['end_price']; ?>
</td>
                <td style="text-align:right;"><?php echo $this->_tpl_vars['dis']['payment_price']; ?>
</td>
                <td style="text-align:right;"><?php echo $this->_tpl_vars['dis']['arrears']; ?>
</td>
...
/payment_after_delivery/approved-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd">审核通过</a>-->
                <a title="驳回" target="dialog" rel="goods_free" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_payment_after_delivery/reason_rejection-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
...
$("#pad_ex").click(function (){
		if($("input[type='checkbox']").is(":checked")){
			alert("即将导出选中数据");
			$("#payment_after_delivery_export").submit();
		}else{
			alert("请选择导出的数据");
		}
	});
