<?php /* Smarty version 2.6.22, created on 2025-01-03 11:54:30
         compiled from hotfix_quotation/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/hotfix_quotation/index">
...
/hotfix_quotation/index" method="get">
	<div class="searchBar">
...
/hotfix_quotation/xls_export" method="post" id="quotation_delete">
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
            <!--<li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/hotfix_quotation/add_production_order/" target="navTab" rel="production_order_add" ><span>填写做货单</span></a></li>-->
            <?php if ($this->_tpl_vars['user_hidden']['group_id'] == '53' || $this->_tpl_vars['user_hidden']['group_id'] == '50' || $this->_tpl_vars['user_hidden']['group_id'] == '5' || $this->_tpl_vars['user_hidden']['group_id'] == '68' || $this->_tpl_vars['user_hidden']['user_id'] == '45'): ?>
            <li class="line">line</li>
			<li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/hotfix_quotation/add/" target="navTab" rel="hotfix_quotation_add" ><span>添加</span></a></li>
            <?php endif; ?>
			<li class="line">line</li>
            <!--<li><a class="delete" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/hotfix_quotation/del/" target="selectedTodo" id="del" rel="group_ids[]" postType="string"><span>删除</span></a></li>
			<li class="line">line</li>-->
			...
			<li class="line">line</li>-->
            <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/hotfix_quotation/add_order/" target="selectedTodo" id="del" rel="group_ids_hot[]" postType="string" title="确定要批量生成订单？"><span>批量生成订单</span></a></li>
...
/hotfix_quotation/change_customer_code/"><span>更新设计对应客户</span></a>
            </li>
			<li class="line">line</li>-->
            <?php endif; ?>
		</ul>
...
" type="checkbox"></td>
                ...
                <?php if ($this->_tpl_vars['dis']['quotation_category'] == 2): ?>
                   <td>有设计</td>
                   <?php else: ?>
                   <td>无设计</td>
                <?php endif; ?>
...
"><?php echo $this->_tpl_vars['dis']['final_quote']; ?>
                ...
                <td>
                   <?php if ($this->_tpl_vars['dis']['d_status'] == '1'): ?>
                        未审核
                ...
                <td>
                   <?php if ($this->_tpl_vars['dis']['p_status'] == '1'): ?>
                        未审核
                   <?php elseif ($this->_tpl_vars['dis']['p_status'] == '2'): ?>
                        审核通过
                   <?php elseif ($this->_tpl_vars['dis']['p_status'] == '3'): ?>
                        驳回
                   <?php else: ?>
...
.html" class="btnDel">删除</a>
                <?php endif; ?>
                <?php if ($this->_tpl_vars['dis']['quotation_category'] == '1'): ?> 
...
/hotfix_quotation/no_edit-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnEdit">编辑</a>
                <?php else: ?>
                <a title="编辑" target="navTab" rel="hotfix_quotation_add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/hotfix_quotation/edit-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnEdit">编辑</a>
                <?php endif; ?>
                ...
                <a title="生成订单" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/hotfix_quotation/add_production_order-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" target="navTab" rel="production_order_add" class="btnAdd" ><span>生成订单</span></a>
                <?php endif; ?>
                </td>
              </tr>
...
/hotfix_quotation/submit_index_update',//通过Ajax取数据的目标页面
...
function update_pcs(key){
	   ...
	   $(document).ready(function(){
		   ...
		   $.ajax({
					url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/hotfix_quotation/update_index',//通过Ajax取数据的目标页面
					data:{"id":id,"pcs":pcs},
					type:'post',//方法，还可以是"post"
					dataType:'text',//数据类型，还有其它的，详见jQuery手册
					success:function(locals)//成功后执行的语句，这里是一个函数，"locals"是返回的数据
