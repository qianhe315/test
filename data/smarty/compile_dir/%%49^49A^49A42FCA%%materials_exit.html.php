<?php /* Smarty version 2.6.22, created on 2016-01-08 14:55:33
         compiled from cn_exit_storehouse/materials_exit.html */ ?>
...
">
                ...
                <div style=" margin-left:5px; margin-top:5px; float:left;">
                    <div style="margin-top:5px;">出库去向：</div><textarea type="text" style="width:315px; height:40px; margin-left:80px; margin-top:-15px;"  name="go_where" value=""></textarea>
                </div>
            </div>     
            </form>        
		</div>
