<?php /* Smarty version 2.6.22, created on 2024-10-24 13:47:03
         compiled from uncheckdesign/design.html */ ?>
...
" class="sIE_No"  readonly="readonly" />
          ...
          <div style="float:left; margin-bottom:5px;">
            ...
            <input type="text" class="sIE_No" style="width:100px;" name="design_NO" readonly="readonly "id="design_NO" value="<?php echo $this->_tpl_vars['design']['design_NO']; ?>
" style="margin-left:-15px;" />
          </div>
           <div style="float:left; margin-bottom:5px;">
            <div class="sIE_l_01_title">颜色数量:</div>
            <input type="text" class="sIE_No" style="width:100px;" name="color_date" readonly="readonly "id="color_date" value="<?php echo $this->_tpl_vars['design']['color_date']; ?>
" style="margin-left:-15px;"  />
          </div>
          ...
          <div style="float:left; margin-bottom:5px;">
              ...
              <input type="text" class="sIE_No" style="width:120px;"  id="stock_code" readonly="readonly" value="<?php echo $this->_tpl_vars['design']['design_name']; ?>
"/>
            </div>
            <div style="float:left; margin-bottom:5px;">
              <div class="sIE_l_01_title">设计类别:</div>
              <input type="text" class="sIE_No"  style="width:120px;" id="stock_code" readonly="readonly" value="<?php echo $this->_tpl_vars['design']['quotation_name']; ?>
"/>
            </div>
            <div style="float:left; margin-bottom:5px;">
              <div class="sIE_l_01_title">设计编号:</div>
              <input type="text" class="sIE_No" style="width:120px;" id="stock_code" readonly="readonly" value="<?php echo $this->_tpl_vars['design']['design_code']; ?>
"/>
            </div>
             <?php if ($this->_tpl_vars['design']['design_category'] != 13): ?>
            <div class="sIE_l_01" style="width:210px; margin-left:30px;">
              <div class="sIE_l_01_title" style="line-height:22px; width:50px; height:100px;margin-left:0px">尺寸:</div>
...
" />
          ...
          <textarea class="add01_textarea" disabled="disabled" onfocus="if(this.value=='销售备注')this.value='';" style="width:220px; height:140px; margin-left:10px;"><?php if ($this->_tpl_vars['design']['note']): ?><?php echo $this->_tpl_vars['design']['note']; ?>
...
" style="line-height:22px;" >
          ...
          <div class="sIE_r_img" style="height:36px; width:350px;  margin-left:20px; margin-top:20px;">
...
/unfinishdesign/content_upload_cdr" style="border:none; width:185px; height:185px;"></iframe>
    ...
    <div class="sIEK" style="margin-top:20px;">
      ...
      <div class="divider" style="margin-top:80px;">divider</div>
...
<?php endif; ?>"/>
              ...
              <div style="float:left; margin-bottom:5px;">
                <div class="sIE_l_01_title">时间:</div>
                <input style="width:100px;" type="text" class="sIE_No"  name="design_content_date" id="design_content_date" readonly="readonly" value="<?php echo $this->_tpl_vars['design_content']['content_insert_time']; ?>
"/>
              </div>
...
" />
          ...
          <div class="sIEK" style=" width:210px;">
            ...
            <textarea disabled="disabled" class="add01_textarea" onfocus="if(this.value=='设计备注')this.value='';" style="width:180px; height:80px; margin-left:20px; margin-top:10px;" name="design_note"><?php if ($this->_tpl_vars['design_content']['design_note']): ?><?php echo $this->_tpl_vars['design_content']['design_note']; ?>
<?php else: ?>设计备注<?php endif; ?></textarea>
            
             <div class="sIE_l_01" style="margin-top:10px;width:100%; margin-left:20px;">
              <div class="sIE_l_01_title" style="width:100%; height:26px;">审核备注:</div>
              <div class="sIE_r01">
                <div class="sIE_r01_div">
...
"> 
                 <textarea name="design_content_verify_note" style="width:180px; height:80px;"><?php echo $this->_tpl_vars['design_content']['design_content_verify_note']; ?>
</textarea>
                  <input value="" type="hidden" id="submit_value<?php echo $this->_tpl_vars['design_content']['id']; ?>
" name="submit_value"  />
                  <input type="hidden" name="design_content_id" value="<?php echo $this->_tpl_vars['design_content']['id']; ?>
" />
                   <input type="hidden" name="design_id" value="<?php echo $this->_tpl_vars['design']['id']; ?>
...
/unfinishdesign/two_img_upload" style="border:none; width:350px; height:380px;"></iframe>
              </div>
              <div style="float:left; margin-top:0px;">
      ...
      <div class="sIE_l_02" style="margin-top:20px;">
        <!--<div class="button" style="margin-left:75%; margin-right:5px;">
          <div class="buttonContent">
            ...
            <button id="design_content_save<?php echo $this->_tpl_vars['design_content']['id']; ?>
" value="1" name="design_content_save"  >确定保存</button>
          </div>
        </div>-->
...
" value="3" name="design_content_callback"  >状态返回</button>
          </div>
        </div>
...
").click(function (){
		$("#submit_value<?php echo $this->_tpl_vars['design_content']['id']; ?>
").val('1');
...
;
		...
		var value=$(this).val();
		// if(design_name.indexOf("Vinyl")!=-1 || design_name.indexOf("Hot-Fix")!=-1 || design_name.indexOf("Hotfix")!=-1 || design_name.indexOf("Printable")!=-1){
		// 	$.ajax({
	    //         async: false,
	    //         type: "POST",
	    //         url: url,
