<?php /* Smarty version 2.6.22, created on 2014-03-14 14:35:19
         compiled from web_inquiries_into/processed.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/web_inquiries_into/processed">
...
/web_inquiries_into/processed" method="get">
	<div class="searchBar">
...
/web_inquiries_into/yidong/" target="selectedTodo" id="del" rel="group_ids_yidong[]" postType="string" title="确定移出列表?"><span>移出列表</span></a></li>				
		<li class="line">line</li>
		</ul>
	</div>
	<table class="table" width="1300" layoutH="138">
		<thead>
			<tr>
				<th width="1%"><input type="checkbox" group="group_ids_yidong" class="checkboxCtrl"></th>
                <th width="8%">时间</th>
                <th width="4%">缩略图</th>
                <th width="4%">询盘方式</th>
                <th width="4%">来自</th>
...
">
                <td><input name="group_ids_yidong[]" id="c_id" value="<?php echo $this->_tpl_vars['dis']['id']; ?>
" type="checkbox"></td>
