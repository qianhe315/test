<?php /* Smarty version 2.6.22, created on 2016-01-08 16:19:29
         compiled from cn_other_register_storage/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_other_register_storage/index">
...
/cn_other_register_storage/index" method="get">
	<div class="searchBar">
...
/cn_other_register_storage/xls_export" method="post" id="new_export_new">
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
        	<li class="line">line</li>
			<li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_other_register_storage/add" target="dialog" rel="cn_other_register_storage"><span>添加</span></a></li>
            <li class="line">line</li>
           ...
           <li><a class="icon" href="#" id="new_ex" ><span>导出EXCEL</span></a></li>
			<li class="line">line</li>
            <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_other_register_storage/materials_exit" target="navTab" rel="tongbu_add"  ><span>材料扫码入库</span></a></li>
             <li class="line">line</li>
			 <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_other_register_storage/del_piliang/" target="selectedTodo" id="del" rel="group_ids[]" postType="string" title="确定要批量删除？"><span>批量删除</span></a></li>
		</ul>
	</div>
	<table class="table" width="98%" layoutH="138">
        ...
        <?php if ($this->_tpl_vars['cn_other_register_storage']): ?>
			 <?php $_from = $this->_tpl_vars['cn_other_register_storage']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
/cn_other_register_storage/del-id-<?php echo $this->_tpl_vars['omr']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" rel="exit_storehouse_edit" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_other_register_storage/edit-id-<?php echo $this->_tpl_vars['omr']['id']; ?>
...
/cn_other_register_storage/change_price',
			type:'post',
			dataType:"text",
...
function where_is_ok(id){
	...
	$.ajax({
		url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_other_register_storage/change_where',
		type:'post',
		dataType:"text",
