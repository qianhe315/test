<?php /* Smarty version 2.6.22, created on 2016-08-05 16:43:45
         compiled from storehouse_amount/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/storehouse_amount/index">
...
/storehouse_amount/index" method="get">
	<div class="searchBar">
...
"  class="date textInput readonly valid" datefmt="yyyy-MM" />
        ...
        <li style="width:10%;">
            ...
            <input type="text" size="10" name="material_name" value="<?php echo $this->_tpl_vars['material_name']; ?>
"   class=""/>
		</li> 
         <li style="width:10%;">
			<label style="width:40px;">颜色：</label>
            <input type="text" size="10" name="material_color" value="<?php echo $this->_tpl_vars['material_color']; ?>
"   class=""/>
		</li> 
        <li style="width:10%;">
			<label style="width:40px;">尺寸：</label>
            <input type="text" size="10" name="material_size" value="<?php echo $this->_tpl_vars['material_size']; ?>
"   class=""/>
		</li> 
        <li style="width:50%;">
			<label style="width:60px;">时间：</label>
...
/storehouse_amount/xls_export" method="post" id="storehouse_export">
...
" type="checkbox"></td>
				...
				<!--<td></td>
                <td></td>-->
                <td><?php echo $this->_tpl_vars['il']['material_chinese_name']; ?>
</td>
                <td><?php echo $this->_tpl_vars['il']['material_name']; ?>
</td>
                <td><?php echo $this->_tpl_vars['il']['material_color']; ?>
</td>
                <td><?php echo $this->_tpl_vars['il']['supplier_color']; ?>
</td>
                <td><?php echo $this->_tpl_vars['il']['supplier_code']; ?>
</td>
                ...
                <?php elseif ($this->_tpl_vars['il']['size_mm'] != ''): ?>
                <td><?php echo $this->_tpl_vars['il']['size_mm']; ?>
mm</td>
                <?php elseif ($this->_tpl_vars['il']['size_m_w'] != ''): ?>
                <td><?php echo $this->_tpl_vars['il']['size_m_w']; ?>
*<?php echo $this->_tpl_vars['il']['size_m_h']; ?>
mm</td>
                 <?php else: ?>
                <td></td>
                <?php endif; ?>
...
/storehouse_amount/update_storehouse',//通过Ajax取数据的目标页面
