<?php /* Smarty version 2.6.22, created on 2022-03-01 14:28:17
         compiled from rhinestone_quotation/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/rhinestone_quotation/index">
...
/rhinestone_quotation/index" method="get">
	<div class="searchBar">
...
/rhinestone_quotation/xls_export" method="post" id="quotation_delete">
...
/rhinestone_quotation/add/" target="navTab" rel="rhinestone_quotation_add" ><span>添加</span></a></li>
        <?php endif; ?>
            <li class="line">line</li>
...
/rhinestone_quotation/del/" target="selectedTodo" id="del" rel="group_ids[]" postType="string"><span>删除</span></a></li>
			...
			<li class="line">line</li>
			<li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/rhinestone_quotation/add_order/" target="selectedTodo" id="del" rel="group_ids[]" postType="string" title="确定要批量添加做货单？"><span>批量添加做货单</span></a></li>
		</ul>
	</div>
		...
		<thead>
			...
			<tr>
               ...
               <!-- <th width="80">做货状态</th> -->
                ...
                <th width="35%" colspan="8">名称&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||颜色&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||尺寸&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||数量&nbsp;&nbsp;&nbsp;||成本价&nbsp;&nbsp;&nbsp;&nbsp;||报价系数&nbsp;&nbsp;&nbsp;&nbsp;||报价&nbsp;&nbsp;&nbsp;&nbsp;||状态</td>
...
" type="checkbox"></td>
                ...
                <?php if ($this->_tpl_vars['dis']['status'] != ""): ?>
                <td><?php echo $this->_tpl_vars['dis']['status1']; ?>
</td>
                <?php else: ?>
                 <td></td>
                 <?php endif; ?>
...
?>
                 ...
                 <td width="50"><?php echo $this->_tpl_vars['d']['chengbenjia']; ?>
</td>
                 <td width="58"><?php echo $this->_tpl_vars['d']['quote_coefficient']; ?>
</td>
                 <td width="34"><?php echo $this->_tpl_vars['d']['baojia']; ?>
</td>
...
/rhinestone_quotation/del-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnDel">删除</a> 
                <?php endif; ?>
                
                <a title="编辑" target="navTab" rel="rhinestone_quotation_add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/rhinestone_quotation/edit-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnEdit">编辑</a> 
                <?php if ($this->_tpl_vars['dis']['status1'] != '未审核'): ?>
                <a title="填写做货单" target="navTab" rel="rhinestone_quotation_add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/rhinestone_quotation/add_production_order-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
