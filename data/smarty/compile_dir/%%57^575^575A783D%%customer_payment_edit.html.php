<?php /* Smarty version 2.6.22, created on 2016-05-20 17:12:16
         compiled from payment_registration_domestic/customer_payment_edit.html */ ?>
<div class="pageContent">
 <form method="post" action="<?php echo $this->_tpl_vars['act']; ?>
" class="pageForm" onsubmit="return validateCallback(this, navTabAjaxDone)" id="customer_payment_edit">
...
" readonly="readonly"/>
        <input type="hidden" size="30" name="mid" value="<?php echo $this->_tpl_vars['mid']; ?>
" readonly="readonly"/>
        <input type="hidden" size="30" name="ids" value="<?php echo $this->_tpl_vars['ids']; ?>
" readonly="readonly"/>
      </div>
...
" readonly="readonly"/>
      ...
      <div class="divider">divider</div>
       <div class="unit">
      	<label>收款金额：</label>
        <input type="text" size="30" name="paid_money"  id="paid_money" value="<?php echo $this->_tpl_vars['payment_detail']['paid_money']; ?>
" class="required number" />
      ...
      <div class="divider">divider</div>
       ...
       <div class="unit">
      	<label>手续费：</label>
        <input type="text" size="30" name="poundage" id="poundage"  value="<?php echo $this->_tpl_vars['payment_detail']['poundage']; ?>
" class="number"/>
      ...
      <div class="unit">
      	<label>余额：</label>
        <input type="text" size="30" name="balance" id="balance"  value="<?php echo $this->_tpl_vars['payment_detail']['balance']; ?>
" class="number"/>
      ...
      <div class="divider">divider</div>
       ...
       <div class="unit">
      	<label>收款日期：</label>
        <input type="text" size="30" name="paid_time"  value="<?php echo $this->_tpl_vars['payment_detail']['paid_time']; ?>
...
?>
                    <?php if ($this->_tpl_vars['payment_detail']['paid_type'] == $this->_tpl_vars['tc']['id']): ?>
...
"><?php echo $this->_tpl_vars['tc']['payment_methods_name']; ?>
      ...
      <div class="unit">
      	<label>付款客户名：</label>
        <input type="text" size="30" name="paid_customer_name"  value="<?php echo $this->_tpl_vars['payment_detail']['paid_customer_name']; ?>
"  />
      </div>
      <div class="divider">divider</div>
      <div class="unit">
      	<label>付款账号：</label>
        <input type="text" size="30" name="paid_account_number"  value="<?php echo $this->_tpl_vars['payment_detail']['paid_account_number']; ?>
"  />
      </div>
      <div class="divider">divider</div>
       <div class="unit">
      	<label>备注：</label>
        <textarea name="financial_note" cols="30" rows="4"><?php echo $this->_tpl_vars['payment_detail']['note']; ?>
</textarea>
      </div>
...
$(document).ready(function()  
{
	$("#submit_customer_payment").click(function (){
		...
		var g=balance.substr(1);//去掉第一位
		var e=c.test(g);
		var m=c.test(balance);
		var f=balance.substr(0, 1);//取第一位
