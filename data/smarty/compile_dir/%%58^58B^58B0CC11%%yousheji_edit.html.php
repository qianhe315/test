<?php /* Smarty version 2.6.22, created on 2016-01-08 14:39:30
         compiled from wrong_product_order/yousheji_edit.html */ ?>
...
function picture_select(){
	...
	if(document.getElementById('picture_select01_edit').value==1){
      ...
      <div class="stkInfEnter" style="width:98%;display:block;" layoutH="30" id="ttbjd_wsj">
    	  ...
    	  <div class="sIE_title" style="width:60%;">烫图报价</div>
        </div>  	   
...
" />
        <div class="sIE_l_02" id="material_info_edit" style="display:none;">
          ...
          <div class="sIE_l_02_div">
            ...
            <input type="text"  class="sIE_size" id="material_quantity_edit" style="width:120px;" />
          </div>
...
/basemethod/get_material_c_infomation',//通过Ajax取数据的目标页面
	...
	$("#insert_material1_edit").click(function (){
		...
		$.ajax({
			url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/wrong_product_order/insert_yousheji_quotation_sheet_material',//通过Ajax取数据的目标页面
			type:'get',//方法，还可以是"post"
...
function getDel(k,row){
   $(document).ready(function(){
	...
	$.ajax({
			url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/wrong_product_order/delete_yousheji_quotation_sheet_material',//通过Ajax取数据的目标页面
			type:'get',//方法，还可以是"post"
