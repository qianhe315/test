<?php /* Smarty version 2.6.22, created on 2013-10-21 15:02:57
         compiled from create_quotation_invoice/create_invoice_china.html */ ?>
...
/image/small_logo.png" alt="cstown" />
            ...
            <div class="quoteK_l_txt">
       	  ...
       	  <div class="quoteK_r">
       	    ...
       	    <div class="quoteK_r_nr">
       	      ...
       	      <div class="quoteK_r_nr_r" style="height:52px;"><?php echo $this->_tpl_vars['customer_code']; ?>
</div>
       	    </div>
            <div class="quoteK_r_nr">
          ...
          <form method="post" id="c_i_c_form" style="width:100%;" action="<?php echo $this->_tpl_vars['act']; ?>
...
inch</option>
                                ...
                                <td><input type="text" name="setup_fee[]" style="width:60px;" class="quoteK_r_nr_r_input aaa" id="setup_fee_1<?php echo $this->_tpl_vars['dis']['id']; ?>
" onKeyUp="setup_fee_a(<?php echo $this->_tpl_vars['dis']['id']; ?>
)" /></td>
                                <td><input type="text" value="<?php echo $this->_tpl_vars['dis']['final_quote']; ?>
" name="final_quote[]" style="width:65px;" class="quoteK_r_nr_r_input bbb" id="final_quote<?php echo $this->_tpl_vars['dis']['id']; ?>
" /></td>
                      ...
                      <div class="quoteK_div">
                        <div class="quoteK_r" style="width:300px;">
                          <div class="quoteK_r_nr" style="width:300px;">
                            ...
                            <div class="quoteK_r_nr_r">
                              <input type="text" name="sub_total" id="sub_total" class="quoteK_r_nr_r_input" value="<?php echo $this->_tpl_vars['price']; ?>
" />
                            </div>
                          </div>
                          <div class="quoteK_r_nr" style="width:300px;">
                          ...
                          <div class="quoteK_r_nr" style="width:300px;">
                            ...
                            <div class="quoteK_r_nr_r">
                              <input type="text" name="price" id="due" value="<?php echo $this->_tpl_vars['price']; ?>
" class="quoteK_r_nr_r_input" style="margin-top:10px;" />
                            </div>
                          </div>
...
" style="width:80px; height:80px;"/></li>
                      ...
                      <div class="quoteK_bot02"><font style="float:left; width:110px;">PayPal:</font> <font style="float:left;">payment@cstown.com</font></div>
                      <div class="quoteK_bot02"><font style="float:left; width:110px;">Wire Transfer:</font> <font style="float:left;">Please contact rhinestone@cstown.com for TT payment.</font></div>
