<?php /* Smarty version 2.6.22, created on 2015-04-21 11:20:07
         compiled from continuous_deduction/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/continuous_deduction/index">
...
/continuous_deduction/index" method="get">
	<div class="searchBar">
            ...
            <li style="width:30%;">
				...
				<select class="combox" name="program"  >
                	<option value="" >请选择补贴项目</option>
                        <option value="社保缴费" <?php if ($this->_tpl_vars['program'] == '社保缴费'): ?> selected="selected"<?php endif; ?>>社保缴费</option>
                        <option value="公积金缴费" <?php if ($this->_tpl_vars['program'] == '公积金缴费'): ?> selected="selected"<?php endif; ?>>公积金缴费</option>
                </select>
			</li>
...
/continuous_deduction/add/" target="dialog" rel="page1"><span>添加</span></a></li>
...
/continuous_deduction/del-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/continuous_deduction/edit-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
