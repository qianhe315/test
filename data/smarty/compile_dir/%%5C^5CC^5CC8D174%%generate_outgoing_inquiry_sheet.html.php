<?php /* Smarty version 2.6.22, created on 2018-11-02 16:57:30
         compiled from procure_outgoing/generate_outgoing_inquiry_sheet.html */ ?>
...
<body>
	<div class="QuoteK" style="font-family:'黑体';">
        ...
        <div class="BuyLeads_title" style="margin-top:10px;">
        	<font style="font-size:16px;">询价单</font><br />
        </div>
          <form method="post" id="generate_outgoing_inquiry_sheet" style="width:100%;" action="<?php echo $this->_tpl_vars['act']; ?>
	      ...
	      <div class="sIE_l_03">
               	<table cellspacing="0" class="sIE_l_04Tab">
                        <tr>
                        	<th>供应商</th>
                            <td colspan="2">
                                <input type="text" name="gongyingshang" value="<?php echo $this->_tpl_vars['gongyingshang']; ?>
" /> 
                            </td>
                            <th>联系人</th>
                            <td colspan="2"><input type="text" name="lianxiren" value="<?php echo $this->_tpl_vars['lianxiren']; ?>
"  /></td>
                        </tr>
                        <tr>
                        	<th>下单人</th>
                        ...
                        <tr>
                        	<th>订单种类</th>
                            <td><input type="text" name="order_type" value="<?php echo $this->_tpl_vars['order_type']; ?>
" size="10" /></td>
                            <th>询价号</th>
                            <td><?php echo $this->_tpl_vars['quotation_code']; ?>
</td>
                            <th>交货日期</th>
...
" />
                        ...
                        <tr>
                        	<th>款式</th>
                            <td colspan="5"><input type="text" name="kuanshi" value="<?php echo $this->_tpl_vars['kuanshi']; ?>
...
" />
        ...
        <div style="width:100%; float:left; line-height:26px; margin-top:10px;">
        	1.送货地址:辽宁省大连市高新园区七贤岭任贤街13号4楼 邮编116085<br />
