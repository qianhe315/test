<?php /* Smarty version 2.6.22, created on 2015-05-21 10:03:47
         compiled from material_delivery_monthly/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/material_delivery_monthly/index">
...
/material_delivery_monthly/index" method="get">
	<div class="searchBar">
...
/material_delivery_monthly/xls_export" method="post" id="new_export_new">
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
        	<li class="line">line</li>
			<li><a class="add" id="delivery_time"  title="获取此时间的材料出库信息?" ><span>获取此时间的材料出库信息</span></a></li>
            <input type="text" size="15" readonly="readonly" name="insert_time" id="insertDeliveryTime" value="<?php echo $this->_tpl_vars['nowTime']; ?>
...
/material_delivery_monthly/materials_exit" target="navTab" rel="tongbu_add"  ><span>材料扫码出库</span></a></li>-->
		</ul>
	</div>
...
" type="checkbox"> <?php echo $this->_tpl_vars['k']+1; ?>
                ...
                <td><?php echo $this->_tpl_vars['pd']['quantity_unit']; ?>
</td>
              </tr>
...
$(document).ready(function(e) {
	$("#delivery_time").click(function (){
		var instime	=	$("#insertDeliveryTime").val();
		//alert(instime);
		$.ajax({
			url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/material_delivery_monthly/add',//通过Ajax取数据的目标页面
