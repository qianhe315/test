<?php /* Smarty version 2.6.22, created on 2016-01-08 16:32:07
         compiled from cn_other_register_storage/add.html */ ?>
...
"><?php echo $this->_tpl_vars['ma']['name']; ?>
     ...
     <div class="unit">
      	<label>单价：</label>
        <input type="text" size="30" name="price" id="price" value=""  class="required" />
     </div>
     <div id="price_error" style="float:left; width:500px; margin-top:10px; color:#F00; display:none; font-size:12px;"></div>
     <div class="divider">divider</div>
     <div class="unit">
      	<label>入库来源：</label>
        <input type="text" size="30" name="go_where" id="go_where" value=""  class="required" />
     </div>
...
/cn_other_register_storage/get_mp_color_infomation',//通过Ajax取数据的目标页面
	...
	$("#submit_form").click(function (){
		...
		$('#go_where_error').css("display","none");
