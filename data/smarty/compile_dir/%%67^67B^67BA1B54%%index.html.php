<?php /* Smarty version 2.6.22, created on 2015-11-23 16:02:05
         compiled from old_client_lost_two/index.html */ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>老客户流失（8个月）</title>
...
;
    ...
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            chart: {
                renderTo: 'old_client_lost_two',
                type: 'column',
                marginRight: 130,
                marginBottom: 50
            },
            title: {
                text: '老客户流失（8个月）最后下单时间为八个月前当月',
                x: -20 //center
            },
            subtitle: {
                text: '',
...
<body>
<div id="old_client_lost_two" style=" float:left; display:block; margin:10px; overflow: auto; width:1020px; height:500px;  line-height:21px; background:#FFF; overflow-x:hidden; overflow-y:hidden;">
</div>
</body>
</html>