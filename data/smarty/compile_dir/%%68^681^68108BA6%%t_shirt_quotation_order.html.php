<?php /* Smarty version 2.6.22, created on 2017-06-28 09:28:53
         compiled from cn_factory_order/t_shirt_quotation_order.html */ ?>
...
<div class="pageContent">
   ...
   <div class="stkInfEnter" style="width:102%;margin-left:-100px;" layoutH="100" id="ttbjd_ysj">
    	 <div class="sIE_title" style="margin-left:-60px;">T恤直喷报价查看</div>
...
" value="2"></td>
               <td><input size="6" readonly type="text" value="<?php echo $this->_tpl_vars['qf']['number']; ?>
" name="materials[0]['shuliang']" id="material_shuliang<?php echo $this->_tpl_vars['qf']['id']; ?>
"></td> 
...
"><img width="50px" height="50px" src="<?php echo $this->_tpl_vars['qf']['image']; ?>
" /></a></td>
