<?php /* Smarty version 2.6.22, created on 2015-07-19 15:45:23
         compiled from check_stock/materials_check_stock.html */ ?>
...
" class="pageForm" enctype="multipart/form-data" onsubmit="return validateCallback(this, navTabAjaxDone)" >       
      <div id="b_o_c_d_Div1" style="width:520px; float:left;">
      	<div style="width:100%; float:left;">
        	盘点时间：<input class="date textInput readonly valid" type="text" readonly="true" datefmt="yyyy-MM" name="time" value="<?php echo $this->_tpl_vars['nowTime']; ?>
">
        </div>
