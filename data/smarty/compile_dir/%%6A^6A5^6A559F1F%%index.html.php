<?php /* Smarty version 2.6.22, created on 2015-12-15 09:45:34
         compiled from product_order_szo/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/product_order_szo/index">
...
/product_order_szo/index" method="get">
...
/product_order_szo/xls_export" method="post" id="product_order_export">
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">

             <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/product_order_szo/create_invoice/" target="selectedTodo" id="del" rel="group_ids_szo[]" postType="string" title="确定要生成发票？"><span>生成发票</span></a></li>
             ...
             <?php endif; ?>-->
             <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/product_order_szo/all_do_goods/" target="selectedTodo"  rel="group_ids_szo[]" postType="string" title="确定批量做货?" ><span>批量做货</span></a></li>
             <li class="line">line</li>
 			<li><a class="add" href="#" id="create_WO" ><span>生成WO</span></a></li>
		</ul>
	</div>
	<table class="table" width="1400" layoutH="138">
		<thead>
			<tr>
				<th width="1%"><input type="checkbox" group="group_ids_szo[]" class="checkboxCtrl"></th>
                <th width="2%">编号</th>
                <th width="8%">时间</th>
                <!--<th width="4%">业务员</th>
                <th width="4%">订单属性</th> -->               
...
">
                <td><input name="group_ids_szo[]" value="<?php echo $this->_tpl_vars['dis']['id']; ?>
" type="checkbox">
                </td>
...
" /> </td>
               ...
               <td>模板订单</td>
               <?php elseif ($this->_tpl_vars['dis']['status'] == '6'): ?>
               <td>601订单</td>
               <?php elseif ($this->_tpl_vars['dis']['status'] == '7'): ?>
               <td>指甲贴报价单</td>
               <?php else: ?>
               <td></td>
               <?php endif; ?>-->
...
X<?php echo $this->_tpl_vars['dis']['cm_h']; ?>
                ...
                <?php if ($this->_tpl_vars['dis']['601_order_make'] == '1'): ?>
                	<td>未做货</td>
                <?php elseif ($this->_tpl_vars['dis']['601_order_make'] == '2'): ?>
                   <td>已做货</td>
                <!--<?php elseif ($this->_tpl_vars['dis']['export_status'] == '3'): ?>
                   <td>问题单</td>
                <?php elseif ($this->_tpl_vars['dis']['export_status'] == '4'): ?>
                   <td>已处理</td>
                <?php elseif ($this->_tpl_vars['dis']['export_status'] == '5'): ?>
                   <td>已撤销</td>-->
                <?php else: ?>   
                   <td></td>
                <?php endif; ?>
...
/product_order_szo/product_order_del-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnDel">删除</a>
                <?php endif; ?>
                <?php endif; ?>
                
                 <a title="编辑" target="navTab"  href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/product_order_szo/edit-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
...
$(document).ready(function()
{
	...
	$("#product_order_invoice").click(function (){
			...
			$("input[name='group_ids_szo[]']:checkbox:checked").each(function(){ //由于复选框一般选中的是多个,所以可以循环输出
				if(check_arr == ''){
					check_arr += $(this).val();
...
/product_order_szo/invoice_status-'+p,//通过Ajax取数据的目标页面
								data:p,
...
/product_order_szo/create_WO_pdf-'+p);
			}	
		});	
});
</script>