<?php /* Smarty version 2.6.22, created on 2014-10-08 14:29:34
         compiled from come_classify/add.html */ ?>
...
" class="pageForm" onsubmit="return validateCallback(this, dialogAjaxDone)">
    <div class="pageFormContent" layoutH="58">
      <div class="unit">
      <input type="hidden" name="mid" value="<?php echo $this->_tpl_vars['come_classify_edit']['id']; ?>
" >
        <label>选择上级名称：</label>
...
" <?php if ($this->_tpl_vars['come_classify_edit']['from_id'] == $this->_tpl_vars['ta']['id']): ?> selected="selected"<?php endif; ?>>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['ta']['name']; ?>
</option>
...
" <?php if ($this->_tpl_vars['come_classify_edit']['from_id'] == $this->_tpl_vars['p']['id']): ?> selected="selected"<?php endif; ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['p']['name']; ?>
</option>
...
" <?php if ($this->_tpl_vars['come_classify_edit']['from_id'] == $this->_tpl_vars['m']['id']): ?> selected="selected"<?php endif; ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['m']['name']; ?>
</option>
...
" <?php if ($this->_tpl_vars['come_classify_edit']['from_id'] == $this->_tpl_vars['n']['id']): ?> selected="selected"<?php endif; ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['n']['name']; ?>
</option>
      ...
      <div class="unit">
      	<label>请输入名称：</label>
        <input type="text" size="30" name="name" id="name" value="<?php echo $this->_tpl_vars['come_classify_edit']['name']; ?>
