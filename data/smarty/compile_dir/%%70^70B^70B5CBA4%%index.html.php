<?php /* Smarty version 2.6.22, created on 2025-01-03 11:59:55
         compiled from invoice/index.html */ ?>
...
/invoice/xls_export" method="post" id="invoice_export">
...
/invoice/bb/" target="selectedTodo" id="del" rel="group_ids_invoice[]" postType="string" title="确定生成销售明细?"><span>添加到销售明细</span></a></li>            
             <li class="line">line</li>-->
...
/invoice/special_invoice_approval/" target="dialog" rel="special_invoice_approval"><span>特殊发票审批</span></a></li>-->
             ...
             <li class="line">line</li>-->
             <!--<li><a class="add" href="#" id="create_invoice_usa_1" ><span>生成发票有图（适用13条订单以下的发票）</span></a></li>
             <li class="line">line</li>-->
             ...
             <!--<li><a class="add" href="#" id="create_invoice_usa_1_no_image"><span>生成发票无图片(适用超过13条订单的发票)</span></a></li>
               <li class="line">line</li> 
...
/invoice/invoice_old/"><span>同步数据</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		<thead>
			<tr>
				<th width="1%"><input type="checkbox" group="group_ids_invoice[]" class="checkboxCtrl"></th>
                <th width="2%">编号</th>
                <th width="6%">时间</th>
                <th width="4%">业务员</th>
                <th width="8%">客户名</th>
...
" />
                ...
                <td>
                    <?php if ($this->_tpl_vars['dis']['approval_status'] != '1'): ?>
...
<?php echo $this->_tpl_vars['dis']['rebate']; ?>
                ...
                <td>
                    <?php if ($this->_tpl_vars['dis']['approval_status'] != '1'): ?>
                <a target="dialog" title="生成发票" rel="" style="color:#980013;" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/invoice/pdf_invoice-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html">生成发票</a>
                    <?php endif; ?>
                </td>
		        ...
		        <td>
                <?php if ($this->_tpl_vars['user_hidden']['user_name'] == $this->_tpl_vars['dis']['saleman_name'] || $this->_tpl_vars['user_hidden']['group_id'] == '5'): ?>
                    <?php if ($this->_tpl_vars['dis']['sales_status'] == '1' && $this->_tpl_vars['dis']['status'] != '2' && $this->_tpl_vars['dis']['approval_status'] == ''): ?>
                        <a target="dialog" title="添加运费" rel="" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/invoice/add_freight-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd"></a>
                    <?php endif; ?>
                    <?php if ($this->_tpl_vars['dis']['sales_status'] == '1'): ?>
                   		<a target="dialog" title="添加折扣" rel="" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/invoice/add_discount-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd"></a>
                    <?php endif; ?>  
...
/invoice/special_invoice_approval-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnEdit"></a>
                    <?php endif; ?>
                    <?php if ($this->_tpl_vars['dis']['audit_type'] == '2' && $this->_tpl_vars['dis']['sales_status'] == '1'): ?>
                    	<a title="确定生成销售明细?" target="ajaxTodo" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/invoice/bb_mingxi-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd"></a>
                    <?php endif; ?>        
...
/invoice/del-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
...
/invoice/sale_detail-'+p,//通过Ajax取数据的目标页面
								data:p,
		...
		//var touid = $("#newtouid").val();
			...
			if(check_arr ==''){
				alert('必须选择客户');
				  ...
				  $.ajax({
					  url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/invoice/fp_review',//通过Ajax取数据的目标页面
					  data:{'id':check_arr},			
					  type:'get',//方法，还可以是"post"
...
/invoice/create_invoice_usa_review-'+p);
						  }else{
							  alert("客户代码不统一！");
						  }
										}
                ...
                if(patt.test(check_arr)){
					...
					var check_arr = '';
						...
						for(var i=0;i<saleman_name01.length;i++){
							...
							if(saleman_name01[i]){
								if(saleman_name01[i]!= $("#saleman_id").val() && $("#saleman_id").val() != 'admin' && $("#saleman_id").val() != '吴兰英' && $("#saleman_id").val() != '杨男'){
									var a = '1';
									alert("只能操作本人信息,请重试！");	break;
								}else{
									$.ajax({
										url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/invoice/fp_duo',//通过Ajax取数据的目标页面
										data:{'id':check_arr},			
										type:'get',//方法，还可以是"post"
										dataType:'json',//数据类型，还有其它的，详见jQuery手册
										success:function(locals)//成功后执行的语句，这里是一个函数，"locals"是返回的数据
                ...
                if(patt.test(check_arr)){
					...
					var check_arr = '';
						...
						for(var i=0;i<saleman_name01.length;i++){
							...
							if(saleman_name01[i]){
								if(saleman_name01[i]!= $("#saleman_id").val() && $("#saleman_id").val() != 'admin' && $("#saleman_id").val() != '吴兰英'){
									var a = 'check_arr';
									alert("只能操作本人信息,请重试！");	break;
								}else{
