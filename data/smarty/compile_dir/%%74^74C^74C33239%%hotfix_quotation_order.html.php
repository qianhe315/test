<?php /* Smarty version 2.6.22, created on 2023-07-20 08:45:29
         compiled from factory_order/hotfix_quotation_order.html */ ?>
...
" readonly class="sIE_No" />
                ...
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">胶纸种类:</div>
                    
                    <input type="text" name="tapedata_id" value="<?php echo $this->_tpl_vars['tapedata_id']; ?>
" readonly class="sIE_No" />
                </div>
                
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">胶纸尺寸:</div>
                    
                    <input type="text" name="tapedata_id" value="" readonly class="sIE_No" />
                </div>                
...
" class="sIE_No" />
                ...
                <div class="sIE_l_01">
                  ...
                  <?php if ($this->_tpl_vars['hot_test'] == '2'): ?>
                    <input type="text" name="hot_test" readonly value="否" class="sIE_No" />
                  <?php elseif ($this->_tpl_vars['hot_test'] == '1'): ?>
                 ...
                 <div class="sIE_l_01" style="margin-left:225px;">
                  ...
                  <?php if ($this->_tpl_vars['dotted_line'] == '2'): ?>
                    <input type="text" name="dotted_line" readonly value="否" class="sIE_No" />
                  <?php elseif ($this->_tpl_vars['dotted_line'] == '1'): ?>
                  	<input type="text" name="dotted_line" readonly value="是" class="sIE_No" />
                  <?php else: ?>
                  	<input type="text" name="dotted_line" readonly value="否" class="sIE_No" />
                  <?php endif; ?>
                </div>   
