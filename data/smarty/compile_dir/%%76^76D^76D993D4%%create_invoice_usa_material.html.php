<?php /* Smarty version 2.6.22, created on 2014-12-02 17:13:27
         compiled from create_quotation_invoice/create_invoice_usa_material.html */ ?>
...
cm</option>
                      ...
                      <?php if ($this->_tpl_vars['dis']['quotation_category'] != '3'): ?>
                       <td align="right" ><?php echo $this->_tpl_vars['dis']['pcs']; ?>
</td>
                      <?php else: ?>   
                      <td align="right" ><?php echo $this->_tpl_vars['dis']['count']; ?>
</td>
                      <?php endif; ?>
               <td align="right"  style=" font-size:12px;font-family:Arial"><?php echo $this->_tpl_vars['dis']['unite_quote']; ?>
</td>
              
               
       
              <td align="right"><?php echo $this->_tpl_vars['dis']['version']; ?>
<input type="hidden" name="setup_fee[]" style="width:60px; text-align:right;" readonly="readonly" value="<?php echo $this->_tpl_vars['dis']['version']; ?>
" class="quoteK_r_nr_r_input aaa" id="setup_fee_1<?php echo $this->_tpl_vars['dis']['id']; ?>
"  /></td>
      
              <td align="right"><?php echo $this->_tpl_vars['dis']['final_quote']; ?>
<input type="hidden" value="<?php echo $this->_tpl_vars['dis']['final_quote']; ?>
" name="final_quote[]"  readonly="readonly" style="width:65px; text-align:right;" class="quoteK_r_nr_r_input bbb" id="final_quote<?php echo $this->_tpl_vars['dis']['id']; ?>
" /></td>
              <input type="hidden" value="<?php echo $this->_tpl_vars['dis']['final_quote']; ?>
                      ...
                      <div class="quoteK_div">
                        <div class="quoteK_r" style="width:300px;">
                          <div class="quoteK_r_nr" style="width:300px;">
                            ...
                            <div class="quoteK_r_nr_r">
                              <input type="text" name="sub_total" id="sub_total" style="text-align:right;"readonly="readonly" class="quoteK_r_nr_r_input" value="<?php echo $this->_tpl_vars['price']; ?>
" />
                            </div>
                          </div>
                          <div class="quoteK_r_nr" style="width:300px;">
                            ...
                            <div class="quoteK_r_nr_r">
                              <input type="text" name="freight" style="text-align:right;"class="quoteK_r_nr_r_input" id="freight_b" onKeyUp="freight_a(<?php echo $this->_tpl_vars['dis']['id']; ?>
)" />
                            </div>
                          </div>
                          ...
                          <div class="quoteK_r_nr" style="width:300px;">
                            ...
                            <div class="quoteK_r_nr_r">
                              <input type="text" name="price" style="text-align:right;"id="due" readonly="readonly" value="<?php echo $this->_tpl_vars['price']; ?>
...
/image/small_logo.png">                        <input type="hidden" name="panduan" value="<?php echo $this->_tpl_vars['panduan']; ?>
">  
    ...
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['dis']):
?>
                       <?php if ($this->_tpl_vars['dis']['quotation_category'] != '3' && $this->_tpl_vars['dis']['image'] != ''): ?>
