<?php /* Smarty version 2.6.22, created on 2016-01-04 17:23:16
         compiled from user_transfer/index.html */ ?>
...
/user_transfer/index" method="get">
	<div class="searchBar">
...
/user_transfer/update_password" method="post" id="update_password_submit">
<div class="pageContent">
	...
	<table class="table" width="50%" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['user_change_list']): ?>
			 <?php $_from = $this->_tpl_vars['user_change_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
