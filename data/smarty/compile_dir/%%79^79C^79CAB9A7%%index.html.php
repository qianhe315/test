<?php /* Smarty version 2.6.22, created on 2024-10-22 16:58:18
         compiled from unassigneddesign/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/unassigneddesign/index">
...
/unassigneddesign/index" method="get">
	<div class="searchBar">
	...
	<div class="panelBar">
		<ul class="toolBar">
           ...
           <?php if ($this->_tpl_vars['user_hidden']['group_id'] == '56' || $this->_tpl_vars['user_hidden']['group_id'] == '5'): ?>
			<li><a title="批量分配客户？" href="#" class="edit" id="unassign_piliang_design"><span>批量分配设计</span></a>
                <select  name="userid" style="font-size:13px;" id="unassign_touid">
...
/unfinishdesign/add/" target="navTab" rel="unfinishdesign_change" ><span>添加烫图设计</span></a></li>
        	<li class="line">line</li>
			<li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/unassigneddesign/add_lhpl/" target="navTab" rel="unfinishdesign_change" ><span>添加灵活品类设计</span></a></li>
            <li class="line">line</li>
			<li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/unfinishdesign/add1/" target="navTab" rel="unfinishdesign_change" ><span>添加烫图换色</span></a></li>
           <?php endif; ?>
	...
	<table class="table" width="100%" layoutH="138">
		<thead>
			<tr>
				<th width="1%"><input type="checkbox" group="unassign_design_ids[]" class="checkboxCtrl"></th>
                <th width="2%">编号</th>
                <th width="8%">缩略图</th>
...
" style="height:100px;">
                <td><input name="unassign_design_ids[]" value="<?php echo $this->_tpl_vars['dis']['id']; ?>
" type="checkbox"></td>
...
-unassined-1.html" class="btnDel">删除</a> 
                    <?php endif; ?>
...
-unassined-1.html" class="btnEdit">编辑</a>
	                        <?php else: ?>
	                           <a title="编辑" target="navTab" rel="unfinishdesign_change" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
...
{	
	//var check_arr = [];
	$("#unassign_piliang_design").click(function (){
			var touid = $("#unassign_touid").val();
			var check_arr = '';
			$("input[name='unassign_design_ids[]']:checkbox:checked").each(function(){ //由于复选框一般选中的是多个,所以可以循环输出
				if(check_arr == ''){
					check_arr += $(this).val();
				}else{
					check_arr += ','+$(this).val();
...
/unassigneddesign/change_to_other_user-'+p,
					type:'get', 
					dataType:'json',
					data:p,
					success:check_back
