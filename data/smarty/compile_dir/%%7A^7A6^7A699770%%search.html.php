<?php /* Smarty version 2.6.22, created on 2013-11-30 09:24:31
         compiled from oldcustomer/search.html */ ?>
<div class="pageContent">
	<form method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/oldcustomer/index" class="pageForm" onsubmit="return navTabSearch(this);">
...
" />
            ...
            <div class="unit">
				 <label style="width:100px;">客户状态：</label>
                   <select  name="active" style="font-size:12px;" class="combox">
                  <option value="">全部</option>
                  <option value="1" <?php if ($this->_tpl_vars['active'] == '1'): ?>selected="selected"<?php endif; ?> >无</option>
                  <option value="2" <?php if ($this->_tpl_vars['active'] == '2'): ?>selected="selected"<?php endif; ?> >活跃</option>
                  <option value="3" <?php if ($this->_tpl_vars['active'] == '3'): ?>selected="selected"<?php endif; ?> >不活跃</option>
                </select>
			</div>
            <div class="unit">
