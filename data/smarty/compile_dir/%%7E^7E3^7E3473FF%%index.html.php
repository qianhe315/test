<?php /* Smarty version 2.6.22, created on 2013-12-18 16:28:52
         compiled from payment_methods/index.html */ ?>
...
/payment_methods/index" method="get">
	<div class="searchBar">
...
/payment_methods/add/" target="dialog" rel="page1"><span>添加</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['payment_methods_list']): ?>
			 <?php $_from = $this->_tpl_vars['payment_methods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
" type="checkbox"></td>
                <td><?php echo $this->_tpl_vars['ug']['payment_methods_name']; ?>
</td>
                <td><a title="删除吗？" target="ajaxTodo" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/payment_methods/del-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/payment_methods/edit-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
