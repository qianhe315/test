<?php /* Smarty version 2.6.22, created on 2015-07-24 10:16:39
         compiled from template_quotation/edit.html */ ?>
        ...
        <div class="sIE_title" style="width:15%;">
          <div class="button">
            <div class="buttonContent">
              <button onclick="document.getElementById('ttbjd_wsj_hot').style.display='block';document.getElementById('ttbjd_ysj_hot').style.display='none';">模板报价单(无设计)</button>
            </div>
          </div>
        </div>
        <?php endif; ?>
...
" style="width:100px;" name="time" class="sIE_No"  readonly="readonly" />
               ...
               <div class="sIE_l_01" style="width:200px;">
                    ...
                    <select class="picture_select01" name="quotation_category_id" id="picture_select01_template" style="width:106px; height:26px;" onchange="design_code_template()" disabled="disabled">
...
" class="sIE_No" style="width:100px;" onkeyup="stock_template();"/>
              ...
              <div class="sIE_l_01" style="width:200px;">
                ...
                <input class="sIE_No"  id="picture_select02" onkeyup="design_code33()" style="width:100px;" type="text" name="quotation_code" value="<?php echo $this->_tpl_vars['quotation_code']; ?>
" readonly="readonly">
              </div>
              <div class="sIE_l_01" style="width:200px;">
...
" style="height:210px; width:210px;" /></div>
    ...
    <?php if ($this->_tpl_vars['quotation_category'] == 8): ?>
      ...
      <div class="stkInfEnter" style="width:98%; display:none;" layoutH="30" id="ttbjd_wsj_hot"> <?php endif; ?>
        <div style="width:100%; float:left;"> <?php if (! $this->_tpl_vars['quotation_category']): ?>
          <div class="sIE_title" style="width:15%;">
            <div class="button">
              <div class="buttonContent">
                <button onclick="document.getElementById('ttbjd_ysj_hot').style.display='block';document.getElementById('ttbjd_wsj_hot').style.display='none';">模板报价单</button>
              </div>
            </div>
          </div>
          <?php endif; ?>
...
" style="width:100px;" />
              ...
              <div class="sIE_l_01" style="width:200px;">
                <div class="sIE_l_01_title">报价名称:</div>
                <input type="text" style="width:100px;" value="<?php echo $this->_tpl_vars['design_pic_name']; ?>
" name="design_pic_name" id="no_design_pic_name" class="sIE_No" />
              </div>
              <div class="sIE_l_01" style="width:200px;">
                <div class="sIE_l_01_title" style=" line-height:26px;">货币:</div>
...
$(document).ready(function()  
{
    ...
    $("#no_design_content_save").click(function(){
		...
		else if($("#no_design_pic_name").val()== ""){
			$("#hq_no_result").css("display","block");
