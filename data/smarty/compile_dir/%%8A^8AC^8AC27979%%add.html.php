<?php /* Smarty version 2.6.22, created on 2016-05-11 10:46:27
         compiled from cn_t_shirt_quotation/add.html */ ?>
...
/rhinestone_quotation/t_add_customer',//通过Ajax取数据的目标页面
		data:{"name":name},
...
$(document).ready(function()  
{
	 $("#submit_add").click(function () {
	    ...
	    $.ajax({
			url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/content_null',//通过Ajax取数据的目标页面
