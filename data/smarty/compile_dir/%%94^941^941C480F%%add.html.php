<?php /* Smarty version 2.6.22, created on 2015-04-24 09:25:29
         compiled from commission_add/add.html */ ?>
...
"><?php echo $this->_tpl_vars['sa']['user_name']; ?>
      ...
      <div class="unit">
      	<label>时间：</label>
        <input type="text" size="20" name="time" id="time" class="date" value="<?php echo $this->_tpl_vars['use_time']; ?>
"  readonly/>
      </div>
      <div class="divider">divider</div>
      <div class="unit">
      	<label>成本扣减：</label>
        <input type="text" size="20" name="cost_cut" id="cost_cut" class="required" value=""  />
      </div>
     <div class="divider">divider</div>
       <div class="unit">
      	<label>运费增添：</label>
        <input type="text" size="20" name="freight_add" id="freight_add" class="required" value=""  />
      </div>
      <div class="divider">divider</div>
