<?php /* Smarty version 2.6.22, created on 2016-05-10 17:06:58
         compiled from cn_t_shirt_quotation/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/index">
...
/cn_t_shirt_quotation/index" method="get">
	<div class="searchBar">
...
/cn_t_shirt_quotation/xls_export" method="post" id="quotation_delete">
...
/cn_t_shirt_quotation/add/" target="navTab" rel="t_shirt_quotation_add" ><span>添加</span></a></li>
        <?php endif; ?>
            <li class="line">line</li>
...
/rhinestone_quotation/del/" target="selectedTodo" id="del" rel="group_ids[]" postType="string"><span>删除</span></a></li>
			...
			<li class="line">line</li>
			<li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/add_order/" target="selectedTodo" id="del" rel="group_ids[]" postType="string" title="确定要批量添加做货单？"><span>批量添加做货单</span></a></li>
		</ul>
	</div>
	<table class="table" width="1600" layoutH="138">
		<thead>
			...
			<tr>
                ...
                <th width="7%">报价编号</th>
                <th width="8%">设计名称</th>
                <th width="30%" colspan="8">款式&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||颜色&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||尺寸&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||系数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||数量&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||喷图尺寸&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||单价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||状态</td>
...
?>
                 ...
                 <td width="110"><?php echo $this->_tpl_vars['d']['name']; ?>
</td>
                 ...
                 <td width="58"><?php echo $this->_tpl_vars['d']['number']; ?>
</td>
