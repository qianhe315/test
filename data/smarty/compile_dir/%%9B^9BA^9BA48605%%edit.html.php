<?php /* Smarty version 2.6.22, created on 2021-09-24 11:36:35
...
" class="pageForm" onsubmit="return validateCallback(this, navTabAjaxDone)">
    <div class="pageFormContent" layoutH="58">
      <div class="unit">
        <label>用户名：</label>
        <input type="text" size="30" name="user_name1" id="user_name1_edit" readonly="readonly" value="<?php echo $this->_tpl_vars['usergroup_info']['user_name']; ?>
" alt="请输入用户名" class="required" remote="" />
        <input type="hidden" name="uuid" value="<?php echo $this->_tpl_vars['usergroup_info']['user_id']; ?>
" />
        <input type="hidden" name="uuid" value="<?php echo $this->_tpl_vars['usergroup_info']['user_id']; ?>
" />
        <input type="hidden" name="userinfo_group" value="<?php echo $this->_tpl_vars['userinfo_group']; ?>
"  />
...
" />
        <span id="user_name1_edit_result_new" class="error" style="display:none;"></span>
      </div>
      <div class="divider">divider</div>
      <div class="unit">
       <label>登录状态：</label>
       <select name="log_status" class="combox">
       	<option value="1" <?php if ($this->_tpl_vars['usergroup_info']['log_status'] == 1): ?>selected="selected" <?php endif; ?>>可用</option>
        <option value="2" <?php if ($this->_tpl_vars['usergroup_info']['log_status'] == 2): ?>selected="selected" <?php endif; ?>>禁用</option>
       </select>
      </div>
      ...
      <div class="unit">
       <label>英文名：</label>
       <input type="text" size="30" name="english_name" id="english_name_edit" value="<?php echo $this->_tpl_vars['usergroup_info']['english_name']; ?>
" alt="请输入英文名" class="required" />
       <span id="english_name_edit_result_new" class="error" style="display:none;"></span>
      </div>
      <div class="divider">divider</div>
      
      <div class="unit">
       <label>代码：</label>
       <input type="text" size="30" name="user_code" id="user_code_edit" value="<?php echo $this->_tpl_vars['usergroup_info']['user_code']; ?>
" alt="请输入代码" class="required" remote="" />
       <span id="user_code_edit_result_new" class="error" style="display:none;"></span>
      </div>
      <div class="divider">divider</div>
      
      <!--<div class="unit">
       <label>性别：</label>
       <input type="radio"  name="sex" id="sex" value="1" <?php if ($this->_tpl_vars['usergroup_info']['sex'] == '1'): ?> checked="checked"<?php endif; ?> />男 <input type="radio"  name="sex" id="sex" value="2" <?php if ($this->_tpl_vars['usergroup_info']['sex'] == '2'): ?> checked="checked"<?php endif; ?> />女 
      </div>-->
      <div class="unit">
      <label>所属公司：</label>
       <input type="radio"  name="gongsi" value="小布涂涂" <?php if ($this->_tpl_vars['usergroup_info']['gongsi'] == '小布涂涂'): ?> checked="checked"<?php endif; ?> />小布涂涂 
       <input type="radio"  name="gongsi" value="涂涂记" <?php if ($this->_tpl_vars['usergroup_info']['gongsi'] == '涂涂记'): ?> checked="checked"<?php endif; ?> />涂涂记 
      </div>
      ...
      <div class="unit">
       <label>入职时间：</label>
       <input type="text"  name="entry_time" readonly="true"  class="date required" value="<?php echo $this->_tpl_vars['usergroup_info']['entry_time']; ?>
"/>
      </div>
      <div class="divider">divider</div>
      ...
      <div class="unit">
       <label>生日：</label>
       <input type="text"  name="birthday" readonly="true"  class="date required" value="<?php echo $this->_tpl_vars['usergroup_info']['birthday']; ?>
"/>
      </div>
      <div class="divider">divider</div>
      ...
      <div class="unit">
       <label>QQ：</label>
       <input type="text"  name="qq"   size="30" value="<?php echo $this->_tpl_vars['usergroup_info']['qq']; ?>
" alt="请输入QQ" remote="" />
      </div>
      <div class="divider">divider</div>
      ...
      <div class="unit">
       <label>邮箱：</label>
       <input type="text"  name="email" id="email_edit"   size="30" value="<?php echo $this->_tpl_vars['usergroup_info']['email']; ?>
" alt="请输入邮箱" class="required email" remote="" />
       <span id="email_edit_result_new" class="error" style="display:none;"></span>
      </div>
      <div class="divider">divider</div>
      
      <div class="unit">
       <label>移动电话：</label>
       <input type="text"  name="cellphone"   size="30" value="<?php echo $this->_tpl_vars['usergroup_info']['cellphone']; ?>
" alt="请输入移动电话" class="phone"  remote="" />
      ...
      <div class="unit">
       <label>固定电话：</label>
       <input type="text"  name="telephone"   size="30" value="<?php echo $this->_tpl_vars['usergroup_info']['telephone']; ?>
" alt="请输入固定电话" class="phone" />
      ...
      <div class="unit">
       ...
       <select class="combox" name="address">
                <option value="">全部</option>
              	<option value="大连" <?php if ($this->_tpl_vars['usergroup_info']['address'] == '大连'): ?>selected="selected"<?php endif; ?>>大连</option>
                <option value="喀左" <?php if ($this->_tpl_vars['usergroup_info']['address'] == '喀左'): ?>selected="selected"<?php endif; ?>>喀左</option>
       </select>
       </div>
      <div class="divider">divider</div>
      ...
      <div class="unit">
       <label>选择用户组：</label>
       <select name="choose_user_group"  id="select_u_g" disabled="disabled">
...
" <?php if ($this->_tpl_vars['usergroup_info']['group_id'] == $this->_tpl_vars['gr']['group_id']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['gr']['group_name']; ?>
</option>
      ...
      <div class="unit" id="little_g" <?php if ($this->_tpl_vars['usergroup_info']['group_id'] != '53' || $this->_tpl_vars['usergroup_info']['group_id'] != '68'): ?> style="display:none"<?php endif; ?> >
       ...
       <select name="choose_little_group" class="combox"  >
        ...
        <option value="NG" <?php if ($this->_tpl_vars['usergroup_info']['little_group'] == 'NG'): ?> selected="selected" <?php endif; ?>>无分组</option>
...
?>
       ...
       <?php if (in_array ( $this->_tpl_vars['gr']['group_id'] , $this->_tpl_vars['userinfo_group'] )): ?>     
       <input name="manage_group[]" type="checkbox" checked="checked" value="<?php echo $this->_tpl_vars['gr']['group_id']; ?>
...
" /><?php echo $this->_tpl_vars['gr']['group_name']; ?>
     ...
     <?php else: ?>
     <input type="hidden"  name="choose_user_group"   size="30" value="<?php echo $this->_tpl_vars['usergroup_info']['group_id']; ?>
"  />
	  <?php endif; ?>
      <?php if ($this->_tpl_vars['group_name_a']): ?>      
      <div class="unit">
        <label>权限设置：</label>
        ...
        <!--<ul class="tree treeFolder treeCheck collapse" oncheck="kkk">-->
          ...
          <li><a>客户管理</a>
             ...
             <li><a tname="zuixinxunpanneirong" tvalue="zuixinxunpanneirong:1" <?php if ($this->_tpl_vars['zuixinxunpanneirong'] == '1'): ?> checked="true" <?php endif; ?>>最新询盘内容</a></li>
             	  <li><a tname="kehuxiadanlv" tvalue="kehuxiadanlv:1" <?php if ($this->_tpl_vars['kehuxiadanlv'] == '1'): ?> checked="true" <?php endif; ?>>客户下单率</a></li>
          ...
          <li><a>销售管理</a>
            <ul>
              ...
              <ul>
                  ...
                  <li><a tname="dingdanpinlei" tvalue="dingdanpinlei:1" <?php if ($this->_tpl_vars['dingdanpinlei'] == '1'): ?> checked="true" <?php endif; ?>>订单品类</a></li>
                  ...
                  <li><a tname="chanpinduibi" tvalue="chanpinduibi:1" <?php if ($this->_tpl_vars['chanpinduibi'] == '1'): ?> checked="true" <?php endif; ?>>产品对比</a></li>
          ...
          <li><a>设计管理</a>
            <ul>
              <li><a tname="weifenpeisheji" tvalue="weifenpeisheji:1" <?php if ($this->_tpl_vars['weifenpeisheji'] == '1'): ?>checked="true" <?php endif; ?>>未分配设计</a></li>
          ...
          <li><a>工厂管理</a>
            <ul>
              ...
              <li><a tname="chexiaodingdan" tvalue="chexiaodingdan:1" <?php if ($this->_tpl_vars['chexiaodingdan'] == '1'): ?>checked="true" <?php endif; ?>>撤销订单</a></li>
             ...
             <!-- <li><a tname="cangkuguanli" tvalue="cangkuguanli:1" <?php if ($this->_tpl_vars['cangkuguanli'] == '1'): ?>checked="true" <?php endif; ?>><a>仓库信息</a></li>-->
              <li><a>仓库管理</a>
              <ul>
            ...
            <!--  <li><a tname="gongyingshangguanli" tvalue="gongyingshangguanli:1" <?php if ($this->_tpl_vars['gongyingshangguanli'] == '1'): ?>checked="true" <?php endif; ?>>供应商管理</a></li>-->
              <li><a>供应商管理</a>
              <ul>
              ...
              <li><a tname="gongyingshangshuxing" tvalue="gongyingshangshuxing:1" <?php if ($this->_tpl_vars['gongyingshangshuxing'] == '1'): ?>checked="true" <?php endif; ?>>供应商属性</a></li>
               <li><a tname="gongyingshangjiesuanqixian" tvalue="gongyingshangjiesuanqixian:1" <?php if ($this->_tpl_vars['gongyingshangjiesuanqixian'] == '1'): ?>checked="true" <?php endif; ?>>供应商结算期限</a></li>
                   </ul>
              <li><a>设置</a>
              <ul>
          ...
          <li><a>报表汇总</a>
              ...
              <ul>
                    ...
                    <li><a tname="yewuyuanyuexiaoshoumingxi" tvalue="yewuyuanyuexiaoshoumingxi:1" <?php if ($this->_tpl_vars['yewuyuanyuexiaoshoumingxi'] == '1'): ?>checked="true" <?php endif; ?>>业务员月销售额明细</a></li>
               ...
               <li><a tname="shejitongjibiao" tvalue="shejitongjibiao:1" <?php if ($this->_tpl_vars['shejitongjibiao'] == '1'): ?>checked="true" <?php endif; ?>>设计统计表</a>
                 <ul>
                    ...
                    <li><a tname="shejixinpinxiaoshoubiao" tvalue="shejixinpinxiaoshoubiao:1" <?php if ($this->_tpl_vars['shejixinpinxiaoshoubiao'] == '1'): ?>checked="true" <?php endif; ?>>设计新品销售表</a></li>
                    <li><a tname="shejizhouqitongji" tvalue="shejizhouqitongji:1" <?php if ($this->_tpl_vars['shejizhouqitongji'] == '1'): ?>checked="true" <?php endif; ?>>设计周期统计表</a></li>
        ...
        <li>
          <div class="buttonActive">
            <div class="buttonContent">
              <button type="button"   id="submit_edit">确认</button>
            </div>
          </div>
        </li>
        <li> </li>
...
/*$("#submit1").click(function (){
	var user_group_name = $("#user_name1").val();
	$(".ckbox.checked>input").each(function(){    
	   chk_value.push($(this).val());    
	});

	$.ajax({
		url: root+'/user/act_add-group_authority-' + chk_value+'-group_name-'+user_group_name+'.html',
		dataType: 'json',
	});
});*/
...
$(document).ready(function()  
{
	...
	$("#submit_edit").click(function (){
			...
			if(!isChn($('#user_name1_edit').val())){
				$('#user_name1_edit_result_new').css("display","block");
				$('#user_name1_edit_result_new').css("background-color","#FF0000");
				$('#user_name1_edit_result_new').css("color","#FFF");
				$('#user_name1_edit_result_new').html('必须为中文且不可包含空格');
			}
			else if(!isAz($('#english_name_edit').val()) || isEmpty($('#english_name_edit').val())){
				$('#user_name1_edit_result_new').css("display","none");
				$('#english_name_edit_result_new').css("display","block");
				$('#english_name_edit_result_new').css("background-color","#FF0000");
				$('#english_name_edit_result_new').css("color","#FFF");
				$('#english_name_edit_result_new').html('必须为英文且不可包含空格');
			}
			
			else if(isEmpty($('#user_code_edit').val())){
				$('#user_name1_edit_result_new').css("display","none");
				$('#english_name_edit_result_new').css("display","none");
				
				$('#user_code_edit_result_new').css("display","block");
				$('#user_code_edit_result_new').css("background-color","#FF0000");
				$('#user_code_edit_result_new').css("color","#FFF");
				$('#user_code_edit_result_new').html('不可包含空格');
			}else{
				
				$('#english_name_edit_result_new').css("display","none");
				$('#user_name1_edit_result_new').css("display","none");
				$('#user_code_edit_result_new').css("display","none");
		
				if($("#user_name1_edit_result_new").is(":visible")){
					
				}
				else if($("#user_code_edit_result_new").is(":visible")){
					
				}
				else if($("#email_result_edit_new").is(":visible")){
					
				}
				else{
					$("#user_name1_edit_result_new").css("display","none");
					$("#user_code_edit_result_new").css("display","none");
					$("#email_edit_result_new").css("display","none");
					$("#user_name1_edit").submit();
				}
			}
	});
	...
	if(this.id == 'user_name1_edit'){
			if(this.value==''){
				$('#user_name1_result_new').css("display","none");
			}
			else{
				$('#user_name1_edit_result_new').html('');
...
/user/select_user_name',
					type:'post',
					 dataType:'json',
					 data:p,
					 success:select_user_name_edit
			    });
			}
		}
		
		if(this.id == 'user_code_edit'){
			if(this.value==''){
				$('#user_code_result_new').css("display","none");
			}
			else{
				$('#user_code_edit_result_new').html('');
				p='user_code='+this.value+'&usergroupid='+usergroupid;
     			$.ajax({url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/user/select_code',type:'post', dataType:'json',data:p,success:select_code_back_edit});
			}
		}
		
		if(this.id == 'email_edit'){
			if(this.value==''){
				$('#email_result_new').css("display","none");
			}
			else{
				$('#email_edit_result_new').html('');
				p='email='+this.value+'&usergroupid='+usergroupid;
     			$.ajax({url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/user/select_email',type:'post', dataType:'json',data:p,success:select_email_back_edit});
			}
		}
...
function select_user_name_edit(data)
	{
		if(data >= 1)
		{
	...
	function select_code_back_edit(data)
	{
		if(data >= 1)
		{
	...
	function select_email_back_edit(data)
	{
		if(data >= 1)
		{
