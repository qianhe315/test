<?php /* Smarty version 2.6.22, created on 2015-11-10 13:56:51
         compiled from user_group_set/all_page.html */ ?>

<div class="pageContent">
	<form method="post" action="<?php echo $this->_tpl_vars['act']; ?>
" class="pageForm" onsubmit="return validateCallback(this, dialogAjaxDone)">
		<div class="pageFormContent" layoutH="58">
            <input type="hidden" name="id" value="<?php echo $this->_tpl_vars['get_info']['group_id']; ?>
" />
            <div class="unit">
                <label>组名：</label>
                <input type="text" size="50" name="group_name" value="<?php echo $this->_tpl_vars['get_info']['group_name']; ?>
"  />
            </div>
