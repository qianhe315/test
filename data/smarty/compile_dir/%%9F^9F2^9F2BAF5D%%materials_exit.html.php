<?php /* Smarty version 2.6.22, created on 2015-09-01 08:56:01
         compiled from exit_storehouse/materials_exit.html */ ?>
...
">
        ...
        <div style="width:520px; float:left; text-align:center; margin-top:5px; border-top:1px solid #CCC; padding-top:5px;"></div>
         <div ><!--
            <label>单位：</label>
            <select class="required" name="unit" id="unit" >
...
" > <?php echo $this->_tpl_vars['du']['name']; ?>
 </option>
