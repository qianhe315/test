<?php /* Smarty version 2.6.22, created on 2015-12-05 10:09:15
         compiled from unfinishdesign/edit1.html */ ?>
...
"><?php echo $this->_tpl_vars['time']['time_name']; ?>
          ...
          <div style="float:left; margin-bottom:5px;">
            ...
            <input type="text" name="customer_code" id="unf_customer_code" style="width:100px;" value="<?php echo $this->_tpl_vars['design']['customer_code']; ?>
...
"  style="width:100px;"  name="color_date" id="color_date"  />
        ...
        <input type="hidden" id="image11" name="image11" value="<?php echo $this->_tpl_vars['design']['upload_file']; ?>
" />
      <input type="hidden" id="image22" name="image22" value="<?php echo $this->_tpl_vars['design']['upload_cdr']; ?>
" />
...
"/>
          ...
          <div style="float:left; margin-bottom:5px;">
            ...
            <input type="text" class="sIE_No" style="width:120px;"  name="yuan_design" id="yuan_design" value="<?php echo $this->_tpl_vars['design']['yuanse_code']; ?>
" onkeyup="yuan_design_aa();" />
          </div>
          <div style="float:left; margin-bottom:5px;">
...
"><?php echo $this->_tpl_vars['mt']['material_name']; ?>
    ...
    <div class="sIE_l_02" style="width:95%;" id="m_list">
      <table cellspacing="0" class="sIE_l_02Tab" id="material_table_unfinish_edit">
        <tr>
          <th>材料</th>
          <th>颜色</th>
          <th>尺寸</th>
...
/unfinishdesign/upload_jpg" style="border:none; width:360px; height:400px;"></iframe>
      ...
      <div id="image111">
      <img width="360" src="<?php echo $this->_tpl_vars['design']['upload_file']; ?>
" />
