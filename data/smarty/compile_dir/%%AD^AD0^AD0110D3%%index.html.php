<?php /* Smarty version 2.6.22, created on 2024-08-27 14:14:31
         compiled from oldcustomer/index.html */ ?>
...
/oldcustomer/search/" target="dialog" mask="true" title="查询框"><span>高级检索</span></a></li> 
...
/oldcustomer/xls_export" method="post" id="new_export_old">
...
"><?php echo $this->_tpl_vars['qf']['user_name']; ?>
      ...
      <?php endif; ?>
      <li class="line">line</li>
      <li><a title="批量修改客户状态？" href="#" class="edit" id="customer_oldpiliang_old"><span>修改客户状态</span></a>
        <select  name="customer_oldtouid" style="font-size:13px;" id="customer_oldtouid_old">
          <option value="2">活跃</option>
          <option value="3">不活跃</option>     
        </select>
      </li>
...
/oldcustomer/update_oldcustomer" target="ajaxTodo" rel="page1" postType="string"   title="确定更新老客户?" ><span>更新老客户</span></a></li>
  ...
  <table class="table" width="98%" layoutH="138">
    <thead>
      <tr>
        <th width="2%"><input type="checkbox" group="old_customer_ids[]" class="checkboxCtrl" id="check_all"  ></th>
        <th width="2%">编号</th>
        <th width="5%">添加日期</th>
        <th width="5%">询盘日期</th>
        <th width="4%">来源渠道</th> 
...
">
      <td><input name="old_customer_ids[]" value="<?php echo $this->_tpl_vars['ug']['id']; ?>
" type="checkbox" ></td>
...
.html" target="navTab" rel="yidong"><?php echo $this->_tpl_vars['ug']['customer_code_num']; ?>
      ...
      <td><a title="编辑" target="navTab" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/quotecustomer/edit-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
.html" class="btnEdit" rel="editcustomer">编辑</a></td>
      </tr>
      <?php endforeach; endif; unset($_from); ?>
      <?php endif; ?>
      </tbody>
...
/*				$("#check_arr").val(check_arr);
		...
		/*修改活跃*/
		$("#customer_oldpiliang_old").click(function (){
			var touid1 = $("#customer_oldtouid_old").val();
			var check_arr1 = '';
			$("input[name='old_customer_ids[]']:checkbox:checked").each(function(){ //由于复选框一般选中的是多个,所以可以循环输出
				if(check_arr1 == ''){
					check_arr1 += $(this).val();
			...
			if(check_arr1 ==''){
				...
				$.ajax({
					url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/oldcustomer/change_to_active-'+p,
					type:'get', 
					dataType:'json',
					data:p,
					success:check_back
