<?php /* Smarty version 2.6.22, created on 2017-03-08 14:50:08
         compiled from selling_goods_detail/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/selling_goods_detail/index">
...
/selling_goods_detail/index" method="get">
	<div class="searchBar">
...
/selling_goods_detail/sgd_export" method="post" id="selling_goods_detail_export">
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
        <li><a class="icon" id="sgd_ex"><span>导出EXCEL</span></a></li>	
		</ul>
	</div>
...
" type="checkbox">
                ...
                <td><?php echo $this->_tpl_vars['or']['take_time']; ?>
</td>
...
$("#sgd_ex").click(function (){
		if($("input[type='checkbox']").is(":checked")){
			alert("即将导出选中数据");
			$("#selling_goods_detail_export").submit();
		}else{
			alert("请选择导出的数据");
		}
	});
