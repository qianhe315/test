<?php /* Smarty version 2.6.22, created on 2016-03-25 09:01:11
         compiled from cn_refund_application_sales/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_refund_application_sales/index">
...
/cn_refund_application_sales/index" method="get">
	<div class="searchBar">
...
/cn_refund_application_sales/ras_xls_export" method="post" id="refund_application_sales_export">
...
/cn_refund_application_sales/shtg/" target="selectedTodo" rel="group_ids[]" postType="string" title="确定批量修改?" ><span>批量审核通过</span></a>
         </li>
         <li class="line">line</li>
		 
         <li><a class="icon" href="#" id="ras_ex" ><span>导出EXCEL</span></a></li>
         <li class="line">line</li>
         <?php endif; ?>
         </ul>
	</div>
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['application_drawback']): ?>
			 <?php $_from = $this->_tpl_vars['application_drawback']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
" type="checkbox"></td>
                ...
                <!--<a title="是否审核通过" target="ajaxTodo" rel="refund_application_sales" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/refund_application_sales/approved-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd">审核通过</a>-->
                <a title="驳回" target="dialog" rel="cn_refund_application_sales" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_refund_application_sales/reason_rejection-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
...
$("#ras_ex").click(function (){
		if($("input[type='checkbox']").is(":checked")){
			alert("即将导出选中数据");
			$("#refund_application_sales_export").submit();
		}else{
			alert("请选择导出的数据");
		}
	});
