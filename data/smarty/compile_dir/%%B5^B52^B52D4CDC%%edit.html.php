<?php /* Smarty version 2.6.22, created on 2015-07-22 17:55:44
         compiled from exit_storehouse/edit.html */ ?>
<div class="pageContent">
  <form method="post" action="<?php echo $this->_tpl_vars['act']; ?>
" class="pageForm" onsubmit="return validateCallback(this, dialogAjaxDone)" id="submit_add">
    <div class="pageFormContent" layoutH="58">
    <input type="hidden" size="30"  name="mid" value="<?php echo $this->_tpl_vars['purchase']['id']; ?>
" />
      <div class="unit">
      	<label>出库日期：</label>
        <input type="text" name="quote_time" id="quote_time" class="date required" readonly value="<?php echo $this->_tpl_vars['purchase']['quote_time']; ?>
"/>
...
"<?php if ($this->_tpl_vars['purchase']['pd_name'] == $this->_tpl_vars['ma']['material_name']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['ma']['material_name']; ?>
</option>
...
"<?php if ($this->_tpl_vars['purchase']['pd_color'] == $this->_tpl_vars['ma']['material_color']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['ma']['material_color']; ?>
</option>
        <?php endforeach; endif; unset($_from); ?> 
        </select>
      </div>
...
"<?php if ($this->_tpl_vars['purchase']['pd_size'] == $this->_tpl_vars['ma']['size']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['ma']['size']; ?>
</option>
        <?php endif; ?>
        <?php if ($this->_tpl_vars['ma']['size_mm'] != ""): ?>
        <option value="<?php echo $this->_tpl_vars['ma']['size_mm']; ?>
"<?php if ($this->_tpl_vars['purchase']['pd_size'] == $this->_tpl_vars['ma']['size_mm']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['ma']['size_mm']; ?>
mm</option>
        <?php endif; ?>
          <?php if ($this->_tpl_vars['ma']['size_m_w'] != ""): ?>
              <option value="<?php echo $this->_tpl_vars['ma']['size_w_h']; ?>
"<?php if ($this->_tpl_vars['purchase']['pd_size'] == $this->_tpl_vars['ma']['size_w_h']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['ma']['size_w_h']; ?>
mm</option>
            <?php endif; ?>
        <?php endforeach; endif; unset($_from); ?> 
        </select>
...
?>
        <?php if ($this->_tpl_vars['purchase']['pd_quantity_unit'] == $this->_tpl_vars['u1']['id']): ?><input type="text" readonly="readonly" name="pd_quantity_unit" value="<?php echo $this->_tpl_vars['u1']['name']; ?>
" id="pd_quantity_unit" /> <?php endif; ?>
        <?php endforeach; endif; unset($_from); ?>
        <!--<select class="combox required" name="pd_quantity_unit" >
...
"><?php echo $this->_tpl_vars['u1']['name']; ?>
      ...
      <div class="unit">
      	<label>出库数量：</label>
        <input type="text" size="30" name="pd_quantity" id="pd_quantity" value="<?php echo $this->_tpl_vars['purchase']['pd_quantity']; ?>
"  class="required" />
      </div>
...
"<?php if ($this->_tpl_vars['purchase']['pd_weight_unit'] == $this->_tpl_vars['u2']['id']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['u2']['name']; ?>
</option>
        <?php endforeach; endif; unset($_from); ?>
        </select>
      ...
      <div class="unit">
      	<label>出库重量：</label>
        <input type="text" size="30" name="pd_weight" id="pd_weight" value="<?php echo $this->_tpl_vars['purchase']['pd_weight']; ?>
" class=""/>
      </div>
