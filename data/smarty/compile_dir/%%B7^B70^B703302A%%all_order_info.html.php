<?php /* Smarty version 2.6.22, created on 2016-04-05 14:25:23
         compiled from cargo_picking/all_order_info.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cargo_picking/all_order_info">
...
/cargo_picking/all_order_info" method="get">
	<div class="searchBar">
...
" />
             ...
             <li style="width:30%;">
				<label style="width:80px;">做货时间：</label>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
            ...
            <li><a class="icon" href="#" id="get_order_info_excel" ><span>导出EXCEL</span></a></li> 
...
/cargo_picking/get_order_info_excel" method="post" id="submit_export">
...
" type="checkbox"></td>
                ...
                <td><?php echo $this->_tpl_vars['od']['end_num']; ?>
</td>
              </tr>
...
//导出Excel的js
$("#get_order_info_excel").click(function (){
		if($("input[type='checkbox']").is(":checked")){
			
			alert("即将导出选中数据");
			$("#submit_export").submit();
		}else{
			alert("请选择导出的数据");
		}
	});
