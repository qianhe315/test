<?php /* Smarty version 2.6.22, created on 2016-03-26 08:50:53
         compiled from cn_factory_order_guonei/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_factory_order_guonei/index">
...
/cn_factory_order_guonei/index" method="get">
	<div class="searchBar">
...
/cn_factory_order_guonei/search/" target="dialog" mask="true" title="查询框"><span>高级检索</span></a></li>            
...
/cn_factory_order_guonei/be_not_do/" class="edit"><span>批量未做货</span></a></li>
            <li class="line">line</li>
			<li>	
                <a title="批量修改已做货？" id="" target="selectedTodo" rel="factory_order_group[]" postType="string" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_factory_order_guonei/be_do/" class="edit"><span>批量已做货</span></a>   
            </li>
            <li class="line">line</li>
            <li><a class="edit" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_factory_order_guonei/bulk_shipment/" target="dialog" id="bulk_shipment"><span>批量发货</span></a></li>
            <li class="line">line</li>
            
            <li><a class="edit" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_factory_order_guonei/bulk_goods/" target="dialog" id="bulk_goods"><span>批量收货</span></a></li>
            <li class="line">line</li>
            <?php endif; ?>
		...
		<thead>
			...
			<tr>
               ...
               <!-- <th width="4%">状态</th>-->
                ...
                <th width="7%">设计名称</th>
                <th width="7%">报价编号</th>
                <th width="22%" colspan="5">名称&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||颜色&nbsp;&nbsp;&nbsp;&nbsp;||尺寸&nbsp;&nbsp;&nbsp;&nbsp;||数量&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;||图片下载</td>
                <th width="5%">发货时间</th>
...
" /></td>
                     <td width="10%"><?php echo $this->_tpl_vars['d']['number']; ?>
<input type="hidden" id="number<?php echo $this->_tpl_vars['dis']['id']; ?>
_<?php echo $this->_tpl_vars['k']; ?>
" value="<?php echo $this->_tpl_vars['d']['number']; ?>
" /></td>
                     <td width="20%"><a href="<?php echo $this->_tpl_vars['d']['image']; ?>
...
/cn_factory_order_guonei/edit-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
...
/cn_factory_order_guonei/export_certificate-'+p);
				}else{
				    return false;	
				}
			}	
...
/*					 if(gao=='gao'){
						if(youxian_status=="低" || youxian_status=="中"){
							 ...
							 window.open('<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_factory_order_guonei/export_doinvoice-'+p);
						}*/
					
					if($("#status"+check_arr).val()==8){
						window.open('<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_factory_order_guonei/export_doinvoice_pdf_Tshirt-'+p);
					}
				}
			}	
		});
...
/cn_factory_order_guonei/change_to_active-'+p,
						type:'get', 
						dataType:'json',
						data:p,
						success:check_back
