<?php /* Smarty version 2.6.22, created on 2014-08-11 16:55:27
         compiled from exceptions_customers/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/exceptions_customers/index">
...
/exceptions_customers/index" method="get">
	<div class="searchBar">
...
/exceptions_customers/xls_export" method="post" id="quoteexport">
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
        <li class="line">line</li>
			<li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/exceptions_customers/add/" target="dialog" rel="page1"><span>添加</span></a></li>
	...
	<table class="table" asc="asc" desc="desc" width="100%" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['exceptions_customers']): ?>
			 <?php $_from = $this->_tpl_vars['exceptions_customers']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
/exceptions_customers/del-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/exceptions_customers/edit-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
