<?php /* Smarty version 2.6.22, created on 2015-12-23 11:47:01
         compiled from materials_cn/barcode.html */ ?>
...
/materials_cn/create_barcode" class="pageForm"  id="create_barcode_add">
...
" readonly='readonly'/>
                ...
                <input type="text" class="textInput" style="width:130px;" name="material_name[]" value="<?php echo $this->_tpl_vars['dis']['material_name']; ?>
" readonly='readonly'/>
...
" readonly='readonly'/>
				...
				<input type="text" class="textInput" style="width:100px;" name="select_size[]" value="<?php echo $this->_tpl_vars['dis']['size']; ?>
" readonly='readonly'/>
