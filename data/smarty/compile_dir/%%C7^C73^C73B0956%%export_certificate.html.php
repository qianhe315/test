<?php /* Smarty version 2.6.22, created on 2015-07-27 15:52:31
         compiled from send_out_info/export_certificate.html */ ?>
...
?>  
                <table cellspacing="0" border="2" class="sIE_l_05Tab" style=" width:320px; float:left; margin-bottom:6px; margin-left:15px; margin-right:10px;">
                    	<tr>
...
"></td>
                        ...
                        <tr height="90px;">
               				<td colspan="2" style="text-align:center"><img src="<?php echo $this->_tpl_vars['dis']['image']; ?>
