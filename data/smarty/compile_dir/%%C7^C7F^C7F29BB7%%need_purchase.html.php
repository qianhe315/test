<?php /* Smarty version 2.6.22, created on 2015-12-14 15:29:06
         compiled from cn_metrial_procure/need_purchase.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_metrial_procure/need_purchase">
...
/cn_metrial_procure/need_purchase" method="get">
	<div class="searchBar">
...
/cn_metrial_procure/metrial_procure_list" method="post">
	<div class="panelBar">
		<ul class="toolBar">
 			<li class="line">line</li>
            <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_metrial_procure/audited/" target="selectedTodo" id="del" rel="group_id[]" postType="string" title="是否批量生成已处理?"><span>已处理</span></a></li>

            <li class="line">line</li>
             <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_metrial_procure/no_audited/" target="selectedTodo" id="del" rel="group_id[]" postType="string" title="是否批量生成未处理?"><span>未处理</span></a></li>
