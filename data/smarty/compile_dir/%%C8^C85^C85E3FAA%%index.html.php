<?php /* Smarty version 2.6.22, created on 2014-09-02 16:21:36
         compiled from free_version_customer/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/free_version_customer/index">
...
/free_version_customer/index" method="get">
	<div class="searchBar">
...
/free_version_customer/xls_export" method="post" id="quoteexport">
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
        <li class="line">line</li>
			<li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/free_version_customer/add/" target="dialog" rel="page1"><span>添加</span></a></li>
	...
	<table class="table" asc="asc" desc="desc" width="100%" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['free_version_customer']): ?>
			 <?php $_from = $this->_tpl_vars['free_version_customer']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
" type="checkbox" ></td>
                ...
                <td>
                <?php if ($this->_tpl_vars['ug']['type'] == '1'): ?>免版费
                <?php elseif ($this->_tpl_vars['ug']['type'] == '2'): ?>订单免检
                <?php elseif ($this->_tpl_vars['ug']['type'] == '3'): ?>先做货免检
                <?php elseif ($this->_tpl_vars['ug']['type'] == '4'): ?>先发货免检
                <?php elseif ($this->_tpl_vars['ug']['type'] == '5'): ?>优先做货
                <?php elseif ($this->_tpl_vars['ug']['type'] == '6'): ?>回收例外客户
                <?php else: ?>
                <?php endif; ?>
                </td>
                <td><a title="删除吗？" target="ajaxTodo" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/free_version_customer/del-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/free_version_customer/edit-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
