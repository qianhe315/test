<?php /* Smarty version 2.6.22, created on 2016-01-09 11:45:58
         compiled from cn_jst_check_stock/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_jst_check_stock/index">
...
/cn_jst_check_stock/index" method="get">
	<div class="searchBar">
...
/cn_jst_check_stock/xls_export" method="post" id="getEx">
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
        <li class="line">line</li>
             <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_jst_check_stock/add" target="navTab" rel="check_stock_add"  ><span>添加</span></a></li>
             <li class="line">line</li>
             <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_jst_check_stock/materials_check_stock" target="navTab" rel="tongbu_add"  ><span>材料扫码盘点</span></a></li>
             <li class="line">line</li>
             <li><a class="icon" href="#" id="get_ex"><span>导出Excel</span></a></li>
			 <li class="line">line</li>
             <li><a class="edit" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_jst_check_stock/all_del/" target="selectedTodo" rel="group_ids[]" postType="string" title="确定要批量删除？"><span>批量删除</span></a></li>
