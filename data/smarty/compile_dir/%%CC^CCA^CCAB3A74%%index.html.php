<?php /* Smarty version 2.6.22, created on 2014-07-17 14:40:55
         compiled from discount_approval/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/discount_approval/index">
...
/discount_approval/index" method="get">
	<div class="searchBar">
...
" style="width:70px;" class="date" readonly="true"/>
        ...
        <select name="customer_status" style="font-size:12px;" class="combox">
          ...
          <option value="4" <?php if ($this->_tpl_vars['customer_status'] == '4'): ?>selected="selected"<?php endif; ?> >过期</option>
        </select>
        </li>
...
/discount_approval/shtg/" target="selectedTodo" rel="group_ids[]" postType="string" title="确定批量修改?" ><span>批量审核通过</span></a>
         </li>
         <li class="line">line</li>
         <?php endif; ?>
         </ul>
...
" type="checkbox"></td>
                ...
                <td><?php echo $this->_tpl_vars['dis']['d_time']; ?>
</td>
                ...
                <td>
                     ...
                     <?php elseif ($this->_tpl_vars['dis']['d_status'] == '3'): ?>
                         驳回
                     <?php elseif ($this->_tpl_vars['dis']['d_status'] == '4'): ?>
                         过期
                     <?php else: ?>   
                ...
                <td><?php echo $this->_tpl_vars['dis']['discount_detail']; ?>
</td>
                <td><?php echo $this->_tpl_vars['dis']['rebut']; ?>
</td>
                <td>
                <?php if ($this->_tpl_vars['dis']['d_status'] != '0'): ?>
                <?php if ($this->_tpl_vars['user_hidden']['group_id'] == '50' || $this->_tpl_vars['user_hidden']['group_id'] == '5'): ?>
                    <?php if ($this->_tpl_vars['dis']['d_status'] != '2'): ?>
<!--                    <a title="是否审核通过" target="ajaxTodo" rel="stock_manage_edit" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/discount_approval/approved-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd">审核通过</a>-->
                    
                    <a title="驳回" target="dialog" rel="reason_rejection" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/discount_approval/reason_rejection-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd">驳回</a>
                    <?php endif; ?>
                
                <a title="是否过期" target="ajaxTodo" rel="stock_manage_edit" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/discount_approval/past_due-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd">是否过期</a>
                <?php endif; ?>
                <?php endif; ?>
                </td>
              </tr>   
