<?php /* Smarty version 2.6.22, created on 2013-12-05 15:09:05
         compiled from quotecategory/index.html */ ?>
...
/quotecategory/index" method="get">
	<div class="searchBar">
...
/quotecategory/add/" target="dialog" rel="page1"><span>添加</span></a></li>
	...
	<table class="table" width="1200" layoutH="138">
		<thead>
			<tr>
                ...
                <th width="22">询盘分类名称</th>

                <th width="70">操作</th>
			</tr>
		</thead>
		<tbody>
        <?php if ($this->_tpl_vars['quotecategory_list']): ?>
...
/quotecategory/del-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/quotecategory/edit-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
