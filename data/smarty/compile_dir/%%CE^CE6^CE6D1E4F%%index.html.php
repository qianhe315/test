<?php /* Smarty version 2.6.22, created on 2016-07-23 10:36:00
         compiled from multiple_orders_do_first_cargo/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/multiple_orders_do_first_cargo/index">
...
/multiple_orders_do_first_cargo/index" method="get">
	<div class="searchBar">
...
" style="width:70px;" class="date" readonly="true"/>
          ...
          <label style="width:60px;">审核状态：</label>
           <select  name="cla_status" style="font-size:12px;" class="combox">
          <option value="">全部</option>
          <option value="1" <?php if ($this->_tpl_vars['cla_status'] == '1'): ?>selected="selected"<?php endif; ?> >未审核</option>
          <option value="2" <?php if ($this->_tpl_vars['cla_status'] == '2'): ?>selected="selected"<?php endif; ?> >审核通过</option>
          <option value="3" <?php if ($this->_tpl_vars['cla_status'] == '3'): ?>selected="selected"<?php endif; ?> >驳回</option>
...
/multiple_orders_do_first_cargo/isrs_xls_export" method="post" id="multiple_orders_do_first_cargo_export">
...
/multiple_orders_do_first_cargo/shtg/" target="selectedTodo" rel="group_ids[]" postType="string" title="确定批量修改?" ><span>批量审核通过</span></a>
            </li>
           	<li class="line">line</li>
            <li>
            <a class="edit" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/multiple_orders_do_first_cargo/bh/" target="selectedTodo" rel="group_ids[]" postType="string" title="确定批量修改?" ><span>批量驳回</span></a>
           	<li class="line">line</li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['customers_list_approval_list']): ?>
			 <?php $_from = $this->_tpl_vars['customers_list_approval_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
" type="checkbox"></td>
                ...
                <td><?php echo $this->_tpl_vars['dis']['deal_amount']; ?>
</td>
                <td><?php echo $this->_tpl_vars['dis']['order_amount']; ?>
</td>
              </tr>
...
$("#isrs_ex").click(function (){
		if($("input[type='checkbox']").is(":checked")){
			alert("即将导出选中数据");
			$("#multiple_orders_do_first_cargo_export").submit();
		}else{
			alert("请选择导出的数据");
		}
	});
