<?php /* Smarty version 2.6.22, created on 2015-12-11 09:23:29
         compiled from cn_check_stock/edit.html */ ?>
...
"<?php if ($this->_tpl_vars['inventory_list']['material_name'] == $this->_tpl_vars['mt']['name']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['mt']['name']; ?>
</option>
...
"<?php if ($this->_tpl_vars['inventory_list']['color'] == $this->_tpl_vars['ma']['id']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['ma']['name']; ?>
</option>
        <?php endforeach; endif; unset($_from); ?>
        </select>
      </div>
...
?>
              <option value="<?php echo $this->_tpl_vars['ma']['id']; ?>
"<?php if ($this->_tpl_vars['inventory_list']['size'] == $this->_tpl_vars['ma']['id']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['ma']['name']; ?>
(<?php echo $this->_tpl_vars['ma']['name1']; ?>
)</option>
        <?php endforeach; endif; unset($_from); ?> 
        </select>
     </div>
