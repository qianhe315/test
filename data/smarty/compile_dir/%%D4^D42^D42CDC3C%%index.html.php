<?php /* Smarty version 2.6.22, created on 2015-11-10 12:53:54
         compiled from user_group_set/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/user_group_set/index">
...
/user_group_set/index" method="get">
	<div class="searchBar">
...
/user_group_set/update_password" method="post" id="update_password_submit">
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
            <li class="line">line</li>
            <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/user_group_set/all_page/" target="dialog" rel="page1" class="btnAdd" ><span>添加</span></a></li>
            <li class="line">line</li>
		</ul>
	</div>
	<table class="table" width="50%" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['user_group_set_list']): ?>
			 <?php $_from = $this->_tpl_vars['user_group_set_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
/user_group_set/del-id-<?php echo $this->_tpl_vars['val']['group_id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/user_group_set/all_page-id-<?php echo $this->_tpl_vars['val']['group_id']; ?>
