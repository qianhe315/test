<?php /* Smarty version 2.6.22, created on 2015-12-11 10:46:21
         compiled from cn_check_stock/materials_check_stock.html */ ?>
...
" class="pageForm" enctype="multipart/form-data" onsubmit="return validateCallback(this, navTabAjaxDone)" >       
            ...
            <div style="width:100%; float:left;">
                盘点时间：<input class="date textInput readonly valid" type="text" readonly="true"  name="time" value="<?php echo $this->_tpl_vars['nowTime']; ?>
">
            </div>
