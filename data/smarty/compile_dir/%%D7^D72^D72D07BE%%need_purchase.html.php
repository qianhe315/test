<?php /* Smarty version 2.6.22, created on 2015-11-30 14:25:41
         compiled from stock_surplus/need_purchase.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/stock_surplus/need_purchase">
...
/stock_surplus/need_purchase" method="get">
	<div class="searchBar">
...
/stock_surplus/need_purchase_del" target="selectedTodo" rel="group_ids[]" postType="string" title="确定要批量删除？" ><span>批量删除</span></a></li>
...
" type="checkbox"></td>
                ...
                <td><?php echo $this->_tpl_vars['ss']['quantity']; ?>
                 ...
                 <td><?php echo $this->_tpl_vars['ss']['unit']; ?>
</td>
                  <?php if ($this->_tpl_vars['ss']['process_status'] == 1): ?>
                <td><a title="编辑" target="dialog" rel="need_purchase_edit" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/stock_surplus/need_purchase_edit-id-<?php echo $this->_tpl_vars['ss']['id']; ?>
