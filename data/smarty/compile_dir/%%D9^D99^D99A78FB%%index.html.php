<?php /* Smarty version 2.6.22, created on 2017-02-04 11:43:41
         compiled from tuikuan_detail/index.html */ ?>
...
/tuikuan_detail/index" method="get">
	<div class="searchBar">
...
/tuikuan_detail/add/" target="dialog" rel="page1"><span>添加</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['tuikuan_detail']): ?>
			 <?php $_from = $this->_tpl_vars['tuikuan_detail']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['ds']):
?>
              <tr target="sid_user" rel="<?php echo $this->_tpl_vars['k']+1; ?>
">
                <td><input name="group_ids" value="<?php echo $this->_tpl_vars['ds']['id']; ?>
" type="checkbox"></td>
                <td><?php echo $this->_tpl_vars['ds']['tui_time']; ?>
</td>
                <td><?php echo $this->_tpl_vars['ds']['fu_time']; ?>
</td>
                <td><?php echo $this->_tpl_vars['ds']['salesman']; ?>
</td>
                <td><?php echo $this->_tpl_vars['ds']['tui_price']; ?>
</td>
                <td><?php echo $this->_tpl_vars['ds']['remark']; ?>
</td>                
                <td><a title="删除吗？" target="ajaxTodo" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/tuikuan_detail/del-id-<?php echo $this->_tpl_vars['ds']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/tuikuan_detail/edit-id-<?php echo $this->_tpl_vars['ds']['id']; ?>
