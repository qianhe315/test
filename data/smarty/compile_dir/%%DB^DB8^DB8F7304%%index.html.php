<?php /* Smarty version 2.6.22, created on 2023-07-20 08:46:03
         compiled from order_process/index.html */ ?>
...
/order_process/index" method="post">
	<div class="searchBar">
		<ul class="searchContent">
			<li style="width:25%;">
				<label>日期：</label>
				<input type="text" name="time" value="<?php echo $this->_tpl_vars['time']; ?>
" class="date"/>
			</li>
...
/order_process/add/" target="dialog" rel="page1"><span>添加</span></a></li>
...
" type="checkbox"></td>
                ...
                <td><?php echo $this->_tpl_vars['ug']['num']; ?>
</td>
                <td><?php echo $this->_tpl_vars['ug']['bar_code']; ?>
</td>
...
/order_process/del-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
