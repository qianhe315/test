<?php /* Smarty version 2.6.22, created on 2014-11-17 11:47:39
         compiled from invoice_status_return/index.html */ ?>
...
/invoice_status_return/index" method="get">
	<div class="searchBar">
...
/invoice_status_return/isrs_xls_export" method="post" id="invoice_status_return_export">
...
$("#isrs_ex").click(function (){
		if($("input[type='checkbox']").is(":checked")){
			alert("即将导出选中数据");
			$("#invoice_status_return_export").submit();
		}else{
			alert("请选择导出的数据");
		}
	});
