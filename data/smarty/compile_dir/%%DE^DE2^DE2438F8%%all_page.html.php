<?php /* Smarty version 2.6.22, created on 2015-11-10 13:21:14
         compiled from user_department_set/all_page.html */ ?>
...
" />
            <div class="unit">
                <label>部门：</label>
                <input type="text" size="50" name="department_name" value="<?php echo $this->_tpl_vars['get_info']['department_name']; ?>
"  />
            </div>
