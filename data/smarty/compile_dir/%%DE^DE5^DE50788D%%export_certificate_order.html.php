<?php /* Smarty version 2.6.22, created on 2014-04-19 09:20:09
         compiled from sale_detail/export_certificate_order.html */ ?>
...
?>  
                <table cellspacing="0" border="2" class="sIE_l_05Tab" style=" width:320px; float:left; margin-bottom:10px; margin-left:15px;">
                		<tr>
                        	<td colspan="2" style=" text-align:center; padding:10px;"><img src="../../1.jpg" width="135" height="30"></td>
                        </tr>
                		
                        <tr>
                        	<!--<th style="width:140px;">Order Number</th>-->
                            <td style=" width:320px; height:220px; padding:5px; font-size:12px;"  colspan="2"><?php echo $this->_tpl_vars['dis']['delivery_order']; ?>
</td>
                        </tr>
                        <tr height="100px;">
                            <td style="text-align:center"><?php echo $this->_tpl_vars['dis']['image']; ?>
</td>
                        </tr>                        
                </table>
