<?php /* Smarty version 2.6.22, created on 2024-10-23 11:07:15
         compiled from uncheckdesign/design_list.html */ ?>
...
" width="100px" height="100px" ></td>
                ...
                <td>
                	<?php if ($this->_tpl_vars['dis']['saleman_check_status'] == 4): ?>
 						审核通过
 					<?php endif; ?>
                </td>
                ...
                <td width="9%" style="word-break : break-all;"><?php echo $this->_tpl_vars['dis']['color']; ?>
</td>
                <td width="9%" style="word-break : break-all;"><?php echo $this->_tpl_vars['dis']['sizes']; ?>
</td>
...
.html" class="btnDel">删除</a> -->
                ...
                <?php if ($this->_tpl_vars['dis']['upload_design_user_name'] == ''): ?>
                    <?php if ($this->_tpl_vars['user_name'] == 'admin' || $this->_tpl_vars['user_name'] == '夏玥鑫'): ?>
                    <a title="删除吗？" target="ajaxTodo" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/uncheckdesign/del_design_content-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
...
/uncheckdesign/edit_design_content-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
-design_id-<?php echo $this->_tpl_vars['design_id']; ?>
