<?php /* Smarty version 2.6.22, created on 2023-02-14 10:07:23
         compiled from goods_free/index.html */ ?>
...
/goods_free/gf_xls_export" method="post" id="goods_free_export">
...
/goods_free/shtg/" target="selectedTodo" rel="group_ids[]" postType="string" title="确定批量修改?" ><span>批量审核通过</span></a>
         </li>
         <li class="line">line</li>
...
/goods_free/reason_rejection-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd">驳回</a>
                <?php endif; ?>
                <a target="dialog" title="添加备注" rel="" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/goods_free/add_beizhu-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
.html" class="btnAdd"></a>
                <?php endif; ?>
                </td>
              </tr>
