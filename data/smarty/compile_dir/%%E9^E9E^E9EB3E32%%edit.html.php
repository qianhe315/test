<?php /* Smarty version 2.6.22, created on 2016-05-11 10:47:35
         compiled from cn_t_shirt_quotation/edit.html */ ?>
...
" class="pageForm" enctype="multipart/form-data" onsubmit="return validateCallback(this, navTabAjaxDone)" id="info_form_add">
            <input type="hidden" name="submit_value" id="submit_value" value="" />
             <input type="hidden" id="mid" name="id" value="<?php echo $this->_tpl_vars['cn_quotation_sheet']['id']; ?>
" />
        <div class="sIE_l" style="width:200px; margin-left:110px; margin-top:25px;">
        <div style="float:left; margin-bottom:5px;">
            <div class="sIE_l_01_title">业务员:</div>
            <input type="text" class="" style="width:100px;height:19px;" id="Saleman_name" name="saleman_name" value="<?php echo $this->_tpl_vars['cn_quotation_sheet']['saleman_name']; ?>
" readonly/> 
         </div>
         
         <div style="float:left; margin-bottom:5px;">
           <div class="sIE_l_01_title">客户代码:</div>
          <input type="text" style="width:100px;height:19px;" id="Customer_code" name="Customer_code" value="<?php echo $this->_tpl_vars['cn_quotation_sheet']['customer_code']; ?>
" class="sIE_No" onkeyup="customer_num_code();"/>
         ...
         <div style="float:left; margin-bottom:5px;">
          ...
          <input type="text" style="width:100px;height:19px;"  id="Customer_name" name="Customer_name"  value="<?php echo $this->_tpl_vars['cn_quotation_sheet']['customer_name']; ?>
" class="" readonly/>
         </div>
         ...
         <div style="float:left; margin-bottom:5px;">
          ...
          <input type="text" style="width:100px;height:19px;"  id="Customer_company" name="Customer_company" value="<?php echo $this->_tpl_vars['cn_quotation_sheet']['customer_company']; ?>
" class="" readonly />
         </div>
...
" class=""  readonly/>
         ...
         <div style="float:left; margin-bottom:5px;">
          ...
          <input type="text" style="width:100px;height:19px;"  id="Quotation_date" name="Quotation_date"value="<?php echo $this->_tpl_vars['cn_quotation_sheet']['quotation_date']; ?>
" class="date" readonly />
         </div>         
         
         <div style="float:left; margin-bottom:5px;">
            <div class="sIE_l_01_title">名称:</div>
            <input type="text" class="" style="width:100px;height:19px;" id="design_pic_name" name="design_pic_name" value="<?php echo $this->_tpl_vars['cn_quotation_sheet']['design_pic_name']; ?>
"/>
         </div>
         ...
         <div style="float:left; margin-bottom:5px;">
          ...
          <input type="text" style="width:100px;height:19px;"  id="Quotation_code" name="Quotation_code"  value="<?php echo $this->_tpl_vars['cn_quotation_sheet']['quotation_code']; ?>
" class="" readonly/>
         </div>
<!--         <div style="float:left; margin-bottom:5px;">
...
" style="height:160px; width:160px;" /></div>
      ...
      <table cellspacing="0" class="sIE_l_02Tab" id="mp_table_add">
        ...
        <?php if ($this->_tpl_vars['cn_quotation_sheet_material'] != ""): ?>
        <?php $_from = $this->_tpl_vars['cn_quotation_sheet_material']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
">
               ...
               <td><input size='10' type='text' name="materials[0][image]" value="<?php echo $this->_tpl_vars['qf']['pic_name']; ?>
" onkeyup="change_image(<?php echo $this->_tpl_vars['qf']['id']; ?>
)" id="material_image<?php echo $this->_tpl_vars['qf']['id']; ?>
"></td>
               <td><input onkeyup="change_image_w(<?php echo $this->_tpl_vars['qf']['id']; ?>
...
/cn_t_shirt_quotation/upload_jpg' target='yframe_unfinish<?php echo $this->_tpl_vars['qf']['id']; ?>
...
/cn_t_shirt_quotation/upload_jpg' style='border:none; width:130px; height:30px;'></iframe><a style='display:none;'>查看</a><a style='display:none;'>浏览</a><div id="xiazai<?php echo $this->_tpl_vars['qf']['id']; ?>
...
" style="display:none;">
                   <form method='post' action='<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/upload_jpg' target='yframe_unfinish' id='add_image' enctype='multipart/form-data'><input type='file' name='ufile' /><input type='hidden' name='h_image' value="<?php echo $this->_tpl_vars['qf']['id']; ?>
" /><input type='submit' value='提交' /></form>
                   </div>
...
$(document).ready(function()  
{
	 $("#submit_edit").click(function () {
	    ...
	    $.ajax({
			url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/content_null_edit',//通过Ajax取数据的目标页面
    ...
    $("#unit_name").change(
    	function()
    	{
			...
			if(a != ''){
				$.ajax({
					url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/get_mp_infomation',//通过Ajax取数据的目标页面
...
/rhinestone_quotation/get_mp_color_infomation',//通过Ajax取数据的目标页面
	...
	$("#liulan").click(function (){
		...
		$.ajax({
			  url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/find_image',//通过Ajax取数据的目标页面
			  type:'post',//方法，还可以是"post"
	...
	$("#material_edit").click(function (){
			...
			$.ajax({
				  url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/find_minorder_1',//通过Ajax取数据的目标页面
				  type:'post',//方法，还可以是"post"
...
/rhinestone_quotation/get_quote_coefficient',//通过Ajax取数据的目标页面
	...
	function change_image(key){
		   ...
		   $(document).ready(function(){
				...
				$.ajax({
					url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/change_image',//通过Ajax取数据的目标页面
	...
	function change_image_w(key){
		   ...
		   $(document).ready(function(){
				...
				$.ajax({
					url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/material_size_w',//通过Ajax取数据的目标页面
	...
	function change_image_h(key){
		   ...
		   $(document).ready(function(){
				...
				$.ajax({
					url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/material_size_h',//通过Ajax取数据的目标页面
	...
	function customer_num(){
		   ...
		   $(document).ready(function(){
				...
				$.ajax({
					url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/contact_name',//通过Ajax取数据的目标页面
	...
	function change_shuliang(key){
		   ...
		   $(document).ready(function(){
				...
				$.ajax({
					url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/shuliang_change',//通过Ajax取数据的目标页面
	...
	function change_xishu(key){
		   $(document).ready(function(){
				...
				$.ajax({
					url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/xishu_change',//通过Ajax取数据的目标页面
					data:{"key":key,"material_price":$("#material_price"+key).val(),"material_xishu":$("#material_xishu"+key).val(),"material_shuliang":$("#material_shuliang"+key).val(),"material_sheji":$("#material_sheji"+key).val(),"clothes_price":$("#clothes_price"+key).val(),"contact_name":contact_name},
					type:'post',//方法，还可以是"post"
					dataType:'text',//数据类型，还有其它的，详见jQuery手册
					success:function(locals)//成功后执行的语句，这里是一个函数，"locals"是返回的数据
	...
	function change_type(key){
		   ...
		   $(document).ready(function(){
				...
				$.ajax({
					url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/type_change',//通过Ajax取数据的目标页面
					data:{"key":key,"material_price":$("#material_price"+key).val(),"material_xishu":$("#material_xishu"+key).val(),"material_shuliang":$("#material_shuliang"+key).val(),"material_sheji":$("#material_sheji"+key).val(),"clothes_price":$("#clothes_price"+key).val(),"contact_name":contact_name},
					type:'post',//方法，还可以是"post"
					dataType:'text',//数据类型，还有其它的，详见jQuery手册
					success:function(locals)//成功后执行的语句，这里是一个函数，"locals"是返回的数据
	...
	function getDel_cl(k,row){
			...
			$.ajax({
					url:'<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_t_shirt_quotation/delete_design_material_cl',//通过Ajax取数据的目标页面
					type:'get',//方法，还可以是"post"
