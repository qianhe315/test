<?php /* Smarty version 2.6.22, created on 2025-01-03 11:54:32
         compiled from hotfix_quotation/add_production_order.html */ ?>
...
"  />
      <input type="hidden" name="product_type" value="<?php echo $this->_tpl_vars['product_type']; ?>
"  />   
              <div class="sIE_l">
                <div class="sIE_l_01">
...
" readonly="readonly" class="sIE_No" />
                ...
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">时间:</div>
                    <input type="text" name="quotation_date" value="<?php echo $this->_tpl_vars['quotation_date']; ?>
" readonly="readonly" class="sIE_No" />
                </div>
...
" readonly="readonly" class="sIE_No" />
                ...
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">发货期:</div>
                    <select name="deliver_goods" id="deliver_goods" class="picture_select01" style="width:82px;">
                       <?php $_from = $this->_tpl_vars['quote_info']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['dis']):
?>
                    	<option value="<?php echo $this->_tpl_vars['dis']['time_name']; ?>
"><?php echo $this->_tpl_vars['dis']['time_name']; ?>
</option>
...
" readonly="readonly" class="sIE_No" />
                ...
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">返单号:</div>
                    ...
                    <input type="text" name="single_number" class="sIE_No alphanumeric" />
                </div>
                <div class="sIE_l_01">
...
" readonly="readonly" class="sIE_No" />
                ...
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">客户提供单号:</div>
                    ...
                    <input type="text" name="customers_order" class="sIE_No" />
                </div>
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">版费:</div>
                    
                    <input type="text" name="costs" class="sIE_No"   readonly="readonly" value="<?php echo $this->_tpl_vars['quotation_sheet_check']['version']; ?>
"/>
                </div>
                ...
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">备损数量:</div>
                    ...
                    <input type="text" name="preparation_number" value="<?php echo $this->_tpl_vars['preparation_number']; ?>
" readonly="readonly" class="sIE_No" /> <!--<div style="line-height:26px; float:left; color:#F00; margin-left:5px;">备损数量不为0，此做货单需要主管审核！</div>-->
                </div>
...
"><?php echo $this->_tpl_vars['oc']['c_name']; ?>
                ...
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">烫压测试:</div>
                  	<input name="hot_test" type="radio" value="1" />是
                    <input name="hot_test" type="radio" value="2" checked="checked" />否
                </div>
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">工厂烫压:</div>
                  	<input name="factory_hot" type="radio" value="1" />是
                    <input name="factory_hot" type="radio" value="2" checked="checked" />否
                </div>
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">多图虚线切割:</div>
                  	<input name="dotted_line" type="radio" value="1" />是
                    <input name="dotted_line" type="radio" value="2" checked="checked" />否
                </div>
                <div class="sIE_l_01">
                  <div class="sIE_l_01_title">载体订单号:</div>
                  	<input type="text" name="carrier_number" style="width:120px;" class="sIE_No" value=""/>
                </div>
                     
               <div id="deliver_goods_result" style="line-height: 26px; float: left; color: rgb(255, 0, 0); margin-left: 5px;"></div>
              ...
              <div class="sIE_r">
                  ...
                  <div class="sIE_r01" style="float:left;">
                    <div class="sIE_r01_div">
                        <input type="text" name="inch_w" readonly="readonly" value="<?php echo $this->_tpl_vars['inch_w']; ?>
" class="sIE_No" />
                        <div style=" margin-left:5px; float:left; line-height:22px;">inch W</div>
                    </div>
                    <div class="sIE_r01_div">
                        <input type="text" name="inch_h" readonly="readonly" value="<?php echo $this->_tpl_vars['inch_h']; ?>
" class="sIE_No" />
                        <div style=" margin-left:5px; float:left; line-height:22px;">inch H</div>
                    </div>
                    <div class="sIE_r01_div">
                        <input type="text" name="cm_w" readonly="readonly" value="<?php echo $this->_tpl_vars['cm_w']; ?>
" class="sIE_No" />
                        <div style=" margin-left:5px; float:left; line-height:22px;">cm W</div>
                    </div>
                    <div class="sIE_r01_div">
                        <input type="text" name="cm_h" readonly="readonly" value="<?php echo $this->_tpl_vars['cm_h']; ?>
" class="sIE_No" />
...
<!--            <textarea name="remark" class="add01_textarea" onfocus="if(this.value=='销售备注')this.value='';" style="width:800px; margin-bottom:10px;">销售备注</textarea>-->
            ...
            <li>
              <div class="buttonActive">
                <div class="buttonContent">
                  <button type="submit" id="design_content_save">确认</button>
                </div>
              </div>
            </li>
            <li>
...
$(document).ready(function()  
{
    ...
    $("#design_content_save").click(function(){
		if(!$(".hq_apo_tabClass").is(":visible")){
			$("#deliver_goods_result").css("display","block");
			$("#deliver_goods_result").html("材料表不可为空！");
		}
		else if($("#order_category").val()==''){
			$("#deliver_goods_result").css("display","block");
			$("#deliver_goods_result").html("请选择报关品类！");
		}
		else{
	    	$("#submit_form").submit();
		}
