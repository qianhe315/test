<?php /* Smarty version 2.6.22, created on 2016-04-07 15:08:38
         compiled from no_deduction_cost_order/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/no_deduction_cost_order/index">
...
/no_deduction_cost_order/index" method="get">
...
/no_deduction_cost_order/sp_xls_export" method="post" id="no_deduction_cost_order_export">
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
       
         <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/no_deduction_cost_order/back_order/" target="selectedTodo" id="del" rel="group_ids[]" postType="string" title="确定返回正常订单?"><span>返回正常订单</span></a></li>   
...
$("#sp_ex").click(function (){
		if($("input[type='checkbox']").is(":checked")){
			alert("即将导出选中数据");
			$("#no_deduction_cost_order_export").submit();
		}else{
			alert("请选择导出的数据");
		}
	});
