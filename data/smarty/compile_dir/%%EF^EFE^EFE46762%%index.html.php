<?php /* Smarty version 2.6.22, created on 2016-02-23 17:00:22
         compiled from cn_outbound_type/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_outbound_type/index">
...
/cn_outbound_type/index" method="get">
	<div class="searchBar">
...
/cn_outbound_type/add/" target="dialog" rel="page1"><span>添加</span></a></li>
	...
	<table class="table" width="1200" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['cn_outbound_type_list']): ?>
			 <?php $_from = $this->_tpl_vars['cn_outbound_type_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
/cn_outbound_type/del-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_outbound_type/edit-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
