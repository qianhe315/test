<?php /* Smarty version 2.6.22, created on 2024-09-02 16:18:16
         compiled from quotecustomer/add.html */ ?>
...
" />
		<input type="hidden" name="sale_user_id" value="<?php echo $this->_tpl_vars['user_id']; ?>
" />
...
'  />
            	...
            	<div class="unit">
		            ...
		            <?php if ($this->_tpl_vars['quote_info_1']['quotefrom_id'] == ''): ?>
		                <select class="combox required" name="quotefrom_id" onchange="qc_webChange_edit(this.value);change_quote(this.value)" id="quotefrom_select" >
...
" <?php if ($this->_tpl_vars['quote_info_1']['quotefrom_id'] == $this->_tpl_vars['qf']['id']): ?> selected="selected" <?php endif; ?> ><?php echo $this->_tpl_vars['qf']['quotefrom_name']; ?>
		                ...
		                <script>
		                	function change_quote(id){
		                		html='<select class="required" name="project_name" id="project_name">';
		                		html+='<option value="">请选择</option>';
		                		html+='<option value="店铺主页">店铺主页</option>';
		                		html+='<option value="商品详情页">商品详情页</option>';
		                		html+='<option value="前台搜索列表页">前台搜索列表页</option>';
		                		html+='<option value="商品收藏页">商品收藏页</option>';
		                		html+='<option value="下单页">下单页</option>';
		                		html+='<option value="大促活动页">大促活动页</option>';
		                		html+='<option value="TM">TM</option>';
		                		html+='<option value="RFQ">RFQ</option>';
		                		if(id==6){
		                			html+='<option value="啦啦询盘">啦啦询盘</option>';
		                		}		                		
		                		html+='</select>';
		                		
		                		$("#project_name").remove();
		                		if(id==6 || id==16){	                			
		                			$("#quote_way").after(html);
		                		}else{
		                			$("#quote_way").after(' <input type="text" size="25" name="project_name" id="project_name" value="<?php echo $this->_tpl_vars['newcustomer']['project_name']; ?>
"  onkeyup="get_same_company(event)"   class="textInput" />');
		                		}
		                	}
		                </script>
		            <?php else: ?>
...
"><?php echo $this->_tpl_vars['qd']['sources_name']; ?>
</option>
		              <?php endforeach; endif; unset($_from); ?>
		            </select>
		          </div>
...
" />
	          ...
	          <div class="unit">
	            <label>公司类型：</label>
	            <input type="checkbox" name="business_type[]" value="1" />制造商
	            <input type="checkbox" name="business_type[]" value="2" />贸易公司
	            <input type="checkbox" name="business_type[]" value="3" />经销商/批发商
	            <input type="checkbox" name="business_type[]" value="4" />采购办事处/代理
	            <input type="checkbox" name="business_type[]" value="5" />商业服务
	            <input type="checkbox" name="business_type[]" value="6" />协会/组织
	            <input type="checkbox" name="business_type[]" value="7" />政府机关
	            <input type="checkbox" id="business_type_other" name="business_type[]" value="8" />其它
...
" />
	          ...
	          <div class="unit">
	            <label>主要销售渠道：</label>
	            <input type="checkbox" name="platforms_selling[]" value="1" />实体店铺
	            <input type="checkbox" name="platforms_selling[]" value="2" />线上店铺
	            <input type="checkbox" name="platforms_selling[]" value="3" />独立网站
	            <input type="checkbox" id="platforms_selling_other" name="platforms_selling[]" value="4" onclick="platforms_selling_message();" />其它
...
" />
          ...
          <div class="unit">
            <label>EORI号：</label>
             <input type="text" name="eori" value="<?php echo $this->_tpl_vars['newcustomer']['eori']; ?>
" />
          </div>  
	      <div class="divider">divider</div>
	          <div class="unit">
	            <label>采购目的：</label>
	            <input type="checkbox" name="purpose[]" value="1" />公司内部使用
	            <input type="checkbox" name="purpose[]" value="2" />销售
	            <input type="checkbox" name="purpose[]" value="3" />生产用
	            <input type="checkbox" name="purpose[]" value="4" />自用
	            <input type="checkbox" name="purpose[]" value="5" />其它
	          </div>
	          <div class="divider">divider</div>
	          <div class="unit">
	            <label>采购频率：</label>
	            <input type="checkbox" name="frequency[]" value="1" />每周一次
	            <input type="checkbox" name="frequency[]" value="2" />一月一次
	            <input type="checkbox" name="frequency[]" value="3" />一季度一次
	            <input type="checkbox" name="frequency[]" value="4" />一年一次
	            <input type="checkbox" name="frequency[]" value="5" />按需采购
	          </div>
	          <div class="divider">divider</div>
	          <div class="unit">
	            <label>年采购额：</label>
	            <input type="checkbox" name="purchasing_volume[]" value="1" />一千美金以下
	            <input type="checkbox" name="purchasing_volume[]" value="2" />1001-10000
	            <input type="checkbox" name="purchasing_volume[]" value="3" />10001-10万
	            <input type="checkbox" name="purchasing_volume[]" value="4" />100001-1百万
	            <input type="checkbox" name="purchasing_volume[]" value="5" />1百万以上
	          </div>
	          <div class="divider">divider</div>
	           <div class="unit">
	            <label>采购品类：</label>
...
?>
	            	<input type="radio" name="attribute" <?php if ($this->_tpl_vars['al']['id'] == 1): ?>checked<?php endif; ?> id="qc_attribute<?php echo $this->_tpl_vars['al']['id']; ?>
...
" class="service_list" style="display:none">
	           <?php endif; ?>    
	          <div class="unit">           
