<?php /* Smarty version 2.6.22, created on 2015-04-21 11:20:06
         compiled from continuous_subsidies/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/continuous_subsidies/index">
...
/continuous_subsidies/index" method="get">
	<div class="searchBar">
		<ul class="searchContent">
			<li style="width:20%;">
				<label>姓名：</label>
                <select class="combox" name="name" id="name"  class="required" >
...
" <?php if ($this->_tpl_vars['name'] == $this->_tpl_vars['ta']['name']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['ta']['name']; ?>
            ...
            <li style="width:30%;">
				<label>补贴项目：</label>
				<select class="combox" name="subsidy_program" id="subsidy_program"  class="required" >
...
?>
                        <option value="<?php echo $this->_tpl_vars['ta']['name']; ?>
" <?php if ($this->_tpl_vars['subsidy_program'] == $this->_tpl_vars['ta']['name']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['ta']['name']; ?>
</option>
                    <?php endforeach; endif; unset($_from); ?>
                </select>
			</li>
...
/continuous_subsidies/add/" target="dialog" rel="page1"><span>添加</span></a></li>
...
" type="checkbox"></td>
                ...
                <td><?php echo $this->_tpl_vars['ug']['subsidy_program']; ?>
</td> 
                <td><?php echo $this->_tpl_vars['ug']['note']; ?>
</td> 
                
                <td><a title="删除吗？" target="ajaxTodo" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/continuous_subsidies/del-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/continuous_subsidies/edit-id-<?php echo $this->_tpl_vars['ug']['id']; ?>
