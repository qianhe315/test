<?php /* Smarty version 2.6.22, created on 2015-12-18 08:57:30
         compiled from cn_metrial_procure/index.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_metrial_procure/index">
...
/cn_metrial_procure/index" method="get">
	<div class="searchBar">
...
" style="width:62px;" />
        ...
        <div class="subBar">
        	<label style="width:100px;">材料采购总额：</label>
...
/cn_metrial_procure/get_mp_excel" method="post">
	<div class="panelBar">
		<ul class="toolBar">
        <?php if ($this->_tpl_vars['s_user_id'] == 1 || $this->_tpl_vars['s_user_id'] == 59): ?>
        <li class="line">line</li>
        <li><a class="add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_metrial_procure/add" target="navTab" rel="add_metrial_procure"><span>添加</span></a></li>
        <li class="line">line</li>
        <li><a class="edit" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_metrial_procure/need_purchase" target="navTab" rel="need_purchase"><span>需采购列表</span></a></li>
        <?php endif; ?>
        <li class="line">line</li>  
        <li><a class="icon" id="get_excel" href="#"><span>导出Excel</span></a></li>
        <li class="line">line</li>   
		</ul>
	</div>
	<table class="table" width="98%" layoutH="138">
		<thead>
			<tr>
				<th width="10"><input type="checkbox" group="group_id[]" class="checkboxCtrl"></th>
                <th width="3%">编号</th>
                <th width="7%">时间</th>
                <th width="8%">采购单号</th>
                <th width="5%">入库状态</th>
...
" type="checkbox"></td>
                ...
                <td><?php echo $this->_tpl_vars['dis']['address_name']; ?>
</td>
...
/cn_metrial_procure/update_tariff',//通过Ajax取数据的目标页面
