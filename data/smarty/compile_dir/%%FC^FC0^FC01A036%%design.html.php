<?php /* Smarty version 2.6.22, created on 2016-03-03 15:16:10
         compiled from cn_uncheckdesign/design.html */ ?>
...
"/>
      ...
      <div class="sIE_l_02" style="margin-top:20px;">
        ...
        <div class="button" style="margin-right:5px;">
          <div class="buttonContent">
            <button id="design_content_callback" value="3" name="design_content_callback"  >状态返回</button>
          </div>
        </div>
        <div class="button">
          <div class="buttonContent">
