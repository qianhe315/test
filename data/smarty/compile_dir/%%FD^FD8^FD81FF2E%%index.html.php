<?php /* Smarty version 2.6.22, created on 2014-12-20 11:24:32
         compiled from flow_book/index.html */ ?>
...
" readonly="true" class="date"/>-<input type="text" name="end_time" style=" width:70px" value="<?php echo $this->_tpl_vars['end_time']; ?>
...
/flow_book/add/" target="dialog" rel="page1"><span>添加</span></a></li>
	...
	<table class="table" width="1200" layoutH="138">
		<thead>
			<tr>
                ...
                <th width="30">添加时间</th>
                <th width="30">时间</th>
                <th width="30">日网站流量</th>
                <th width="70">操作</th>
			</tr>
		</thead>
		<tbody>
        <?php if ($this->_tpl_vars['flow_book']): ?>
			 <?php $_from = $this->_tpl_vars['flow_book']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
/flow_book/del-id-<?php echo $this->_tpl_vars['fb']['id']; ?>
.html" class="btnDel">删除</a> <a title="编辑" target="dialog" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/flow_book/edit-id-<?php echo $this->_tpl_vars['fb']['id']; ?>
