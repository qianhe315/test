<?php /* Smarty version 2.6.22, created on 2016-03-23 11:08:30
         compiled from cn_unfinishdesign/design_list.html */ ?>
<form id="pagerForm" method="post" action="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_unfinishdesign/design_list">
...
/cn_unfinishdesign/design_list" method="get">
	<div class="searchBar">
...
/cn_unfinishdesign/design_content_add-design_id-<?php echo $this->_tpl_vars['design_id']; ?>
-total_count-<?php echo $this->_tpl_vars['total_count']; ?>
.html" target="navTab" rel="cn_design_content_add" ><span>添加设计内容</span></a></li>
...
" type="checkbox"></td>
                ...
                <td style="height:100px;"><img src="<?php echo $this->_tpl_vars['dis']['upload_png']; ?>
" width="100px" height="100px" ></td>
                <td><?php echo $this->_tpl_vars['dis']['customer_code']; ?>
</td>
 				<td><?php echo $this->_tpl_vars['dis']['design_content_code']; ?>
</td>
                <td><?php echo $this->_tpl_vars['dis']['content_cm_w']; ?>
X<?php echo $this->_tpl_vars['dis']['content_cm_h']; ?>
</td>
                <td><?php echo $this->_tpl_vars['dis']['design_content_name']; ?>
</td>
...
/cn_unfinishdesign/del_design_content-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
-design_id-<?php echo $this->_tpl_vars['design_id']; ?>
.html" class="btnDel">删除</a> 
                <a title="编辑" target="navTab" rel="cn_design_content_add" href="<?php echo $this->_tpl_vars['__ROOT__']; ?>
/cn_unfinishdesign/edit_design_content-id-<?php echo $this->_tpl_vars['dis']['id']; ?>
-total_count-<?php echo $this->_tpl_vars['total_count']; ?>
-design_id-<?php echo $this->_tpl_vars['design_id']; ?>
