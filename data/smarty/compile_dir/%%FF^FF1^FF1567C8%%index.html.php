<?php /* Smarty version 2.6.22, created on 2015-11-26 17:20:11
         compiled from standard_cn/index.html */ ?>
...
/standard_cn/add/" target="dialog" rel="page1"><span>添加</span></a></li>
	...
	<table class="table" width="1200" layoutH="138">
		...
		<tbody>
        <?php if ($this->_tpl_vars['cn_standard_list']): ?>
			 <?php $_from = $this->_tpl_vars['cn_standard_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
